...
var doc = function doc(ThemeContext) {
  var DocumentedThemeContext = (0, _reactDesc.describe)(ThemeContext)
    .availableAt((0, _mixins.getAvailableAtBadge)('ThemeContext'))
  ...
  DocumentedThemeContext.propTypes = {
    value: _reactDesc.PropTypes.shape({}).description(
