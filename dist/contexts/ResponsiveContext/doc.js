...
var doc = function doc(ResponsiveContext) {
  var DocumentedResponsiveContext = (0, _reactDesc.describe)(ResponsiveContext)
    .availableAt((0, _mixins.getAvailableAtBadge)('ResponsiveContext'))
    .description(
