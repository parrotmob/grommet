...
var Menu = /*#__PURE__*/ forwardRef(function(props, ref) {
  ...
  var controlButtonIndex = useMemo(
    function() {
  ...
  var controlMirror = /*#__PURE__*/ React.createElement(
    Box,
    {
      flex: false,
    },
    ...
    /*#__PURE__*/ React.createElement(
      ...
      _extends(
        ...
        buttonProps,
        {
          ...
          onOpen: onDropOpen,
          onClose: onDropClose,
          dropContent: /*#__PURE__*/ React.createElement(
            Keyboard,
            {
