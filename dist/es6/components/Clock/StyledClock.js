...
var StyledHour = styled.line.withConfig({
  ...
  ['stroke-width:', ';stroke:', ';transition:stroke 1s ease-out;'],
  function(props) {
...
var StyledDigitalDigit = styled.div.withConfig({
  ...
  ['position:relative;width:0.8em;text-align:center;overflow:hidden;', ';'],
  function(props) {
...
var StyledDigitalPrevious = styled.div.withConfig({
  ...
  [
    'position:absolute;top:0;left:0;width:0.8em;text-align:center;animation:',
    ' 0.5s forwards;',
  ],
  function(props) {
