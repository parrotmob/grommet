...
var MaskedInput = /*#__PURE__*/ forwardRef(function(_ref, ref) {
  ...
  var onPreviousOption = useCallback(
    function(event) {
  ...
  var onSelectOption = useCallback(
    function(event) {
