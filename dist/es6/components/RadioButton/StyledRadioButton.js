...
})(['opacity:0;-moz-appearance:none;width:0;height:0;margin:0;', ';'], function(
  props,
) {
  return !props.disabled && 'cursor: pointer;';
});
...
var StyledRadioButtonLabel = styled.span.withConfig({
  ...
  return (
    ...
    css(['font-weight:', ';'], props.theme.radioButton.font.weight)
  );
});
...
var StyledRadioButtonIcon = styled.svg.withConfig({
  ...
  ['box-sizing:border-box;width:', ';height:', ';fill:', ';', ';'],
  function(props) {
