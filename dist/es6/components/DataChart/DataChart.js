...
var DataChart = /*#__PURE__*/ forwardRef(function(_ref, ref) {
  ...
  var stackElement = /*#__PURE__*/ React.createElement(
    Stack,
    {
      gridArea: 'charts',
    ...
    guide &&
      guide.x &&
      /*#__PURE__*/ React.createElement(XGuide, {
        guide: guide,
        pad: pad,
      }),
    guide &&
      guide.y &&
      /*#__PURE__*/ React.createElement(YGuide, {
        guide: guide,
        pad: pad,
      }),
        ...
        return prop
          .map(function(cProp, j) {
            ...
            return /*#__PURE__*/ React.createElement(
              Chart, // eslint-disable-next-line react/no-array-index-key
              _extends(
                {
  ...
  if (!Grid.available) {
    ...
    if (xAxisElement) {
      _content = /*#__PURE__*/ React.createElement(
        Box,
        null,
        _content,
        xAxisElement,
