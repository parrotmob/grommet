...
var colorType = PropTypes.oneOfType([
  PropTypes.string,
  PropTypes.arrayOf(
    PropTypes.shape({
...
var thicknessType = PropTypes.oneOfType([
  PropTypes.oneOf([
    'hair',
    'xsmall',
    'small',
...
var chartType = PropTypes.oneOfType([
  PropTypes.string,
  PropTypes.shape({
...
var seriesType = PropTypes.oneOfType([
...
export var doc = function doc(DataChart) {
  var DocumentedDataChart = describe(DataChart)
