...
var Message = function Message(_ref) {
  ...
  if (message) {
    ...
    if (typeof message === 'string')
      messageContent = /*#__PURE__*/ React.createElement(Text, rest, message);
    else messageContent = /*#__PURE__*/ React.createElement(Box, rest, message);
...
var FormField = /*#__PURE__*/ forwardRef(function(_ref3, ref) {
  ...
  if (!themeBorder) {
    contents = /*#__PURE__*/ React.createElement(
      Box,
  ...
  if (requiredIndicator === true)
    ...
    requiredIndicator = /*#__PURE__*/ React.createElement(
      Text,
      {
        a11yTitle: 'required',
      },
