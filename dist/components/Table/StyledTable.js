...
var sizeStyle = (0, _styledComponents.css)(
  ['width:', ';max-width:', ';overflow:hidden;'],
  function(props) {
    return (
...
var StyledTableCell = _styledComponents['default'].td.withConfig({
  ...
  [
    'margin:0;padding:0;font-weight:inherit;text-align:inherit;',
    ' ',
    ' ',
    ' ',
    ' ',
...
var StyledTable = _styledComponents['default'].table.withConfig({
  ...
  [
    'border-spacing:0;border-collapse:collapse;width:inherit;@media all and (min--moz-device-pixel-ratio:0){table-layout:fixed;}',
    ' ',
    ';',
  ],
