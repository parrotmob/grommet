...
var buildInteractiveProps = function buildInteractiveProps(
  _ref2,
  activeFunc,
  active,
) {
...
var WorldMap = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref3, ref) {
  ...
  _react['default'].useEffect(
    function() {
      if (continentsProp) {
        setContinents(
          continentsProp.reduce(function(obj, continent) {
  ...
  var onMouseMove = _react['default'].useCallback(
    function(event) {
  ...
  var continentElements = world.continents.map(function(_ref5) {
    ...
    var _ref6 = continents[name] || {},
      ...
      restContinents = _objectWithoutPropertiesLoose(_ref6, [
        'color',
        'onClick',
        'onHover',
      ]);
    ...
    return /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ _react['default'].createElement('path', {
        d: dots,
        strokeLinecap: 'round',
        strokeWidth: (0, _utils.parseMetricToNum)(
          theme.worldMap.continent[active ? 'active' : 'base'],
        ),
        stroke: (0, _utils.normalizeColor)(
  ...
  var placeElements = places.map(function(place) {
    var placeColor = place.color,
      ...
      restPlace = _objectWithoutPropertiesLoose(place, [
        'color',
        'coords',
        'key',
        'name',
  ...
  if (activeCoords) {
    var d =
      'M' + FACTOR * activeCoords[0] + ', ' + FACTOR * activeCoords[1] + ' h0';
    active = /*#__PURE__*/ _react['default'].createElement(
      'g',
      {
        stroke: 'none',
        fill: 'none',
