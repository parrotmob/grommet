...
var doc = function doc(WorldMap) {
  var DocumentedWorldMap = (0, _reactDesc.describe)(WorldMap)
    .availableAt((0, _mixins.getAvailableAtBadge)('WorldMap', 'Visualizations'))
  ...
  DocumentedWorldMap.propTypes = _extends({}, _propTypes.genericProps, {
    ...
    continents: _reactDesc.PropTypes.arrayOf(
      _reactDesc.PropTypes.shape({
        color: _propTypes.colorPropType,
        name: _reactDesc.PropTypes.oneOf([
          'Africa',
          'Asia',
          'Australia',
          'Europe',
    ...
    onSelectPlace: _reactDesc.PropTypes.func.description(
      'Called when the user clicks on a place.\n        It is passed the location.',
    ),
    places: _reactDesc.PropTypes.arrayOf(
      _reactDesc.PropTypes.shape({
        color: _propTypes.colorPropType,
        name: _reactDesc.PropTypes.string,
        // for a11y aria-label
        location: _reactDesc.PropTypes.arrayOf(_reactDesc.PropTypes.number)
          .isRequired,
        onClick: _reactDesc.PropTypes.func,
        onHover: _reactDesc.PropTypes.func,
      }),
    ...
    hoverColor: _propTypes.colorPropType.description(
