...
var doc = function doc(RadioButton) {
  var DocumentedRadioButton = (0, _reactDesc.describe)(RadioButton)
    .availableAt((0, _mixins.getAvailableAtBadge)('RadioButton', 'Input'))
  ...
  DocumentedRadioButton.propTypes = {
    ...
    checked: _reactDesc.PropTypes.bool.description(
