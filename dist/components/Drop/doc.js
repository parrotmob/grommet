...
var dropOverflowPropTypes = _reactDesc.PropTypes.oneOfType([
  _reactDesc.PropTypes.oneOf(_doc.OVERFLOW_VALUES),
...
var doc = function doc(Drop) {
  var DocumentedDrop = (0, _reactDesc.describe)(Drop)
    .availableAt((0, _mixins.getAvailableAtBadge)('Drop', 'Controls'))
  ...
  DocumentedDrop.propTypes = {
    ...
    responsive: _reactDesc.PropTypes.bool
      ...
      .defaultValue(true),
    restrictFocus: _reactDesc.PropTypes.bool
      .description('Whether the drop should control focus.')
      .defaultValue(false),
    stretch: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf(['align']),
    ])
      .description(
    ...
    plain: _reactDesc.PropTypes.bool
      ...
      .defaultValue(false),
    trapFocus: _reactDesc.PropTypes.bool
