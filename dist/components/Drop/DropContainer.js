...
var DropContainer = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var portalContext =
    (0, _react.useContext)(_utils.PortalContext) || defaultPortalContext;
  var portalId = (0, _react.useMemo)(
    function() {
      return portalContext.length;
    },
    [portalContext],
  );
  var nextPortalContext = (0, _react.useMemo)(
    function() {
      ...
      var place = function place(preserveHeight) {
        ...
        if (container && target) {
          ...
          if (align.top) {
            ...
            var percentVisibleAreaBelow =
              100 - (targetRect.bottom / windowHeight) * 100; // Check whether it is within 20% from bottom of the window or
          ...
          if (!preserveHeight) {
            if (theme.drop && theme.drop.maxHeight) {
              maxHeight = Math.min(
                maxHeight,
                (0, _utils.parseMetricToNum)(theme.drop.maxHeight),
              );
            }
  ...
  if (theme.global.drop.background) {
    var dark = (0, _utils.backgroundIsDark)(
    ...
    if (dark !== undefined && dark !== theme.dark) {
      content = /*#__PURE__*/ _react['default'].createElement(
        _styledComponents.ThemeContext.Provider,
        {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ _react['default'].createElement(
        _Keyboard.Keyboard, // should capture keyboard event before other elements,
        // such as Layer
