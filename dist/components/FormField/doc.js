...
var doc = function doc(FormField) {
  var DocumentedFormField = (0, _reactDesc.describe)(FormField)
    .availableAt((0, _mixins.getAvailableAtBadge)('FormField', 'Input'))
    .description(
  ...
  DocumentedFormField.propTypes = {
    ...
    component: _reactDesc.PropTypes.oneOfType([
    ...
    contentProps: _reactDesc.PropTypes.object.description(
    ...
    pad: _reactDesc.PropTypes.bool.description(
      'Whether to add padding to align with the padding of TextInput.',
    ),
    required: _reactDesc.PropTypes.bool.description(
      'Whether the field is required.',
    ),
    validate: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.shape({
        regexp: _reactDesc.PropTypes.instanceOf(RegExp),
        // regular expression
        message: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.string,
          _reactDesc.PropTypes.node,
        ]),
