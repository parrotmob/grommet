...
var FormFieldContentBox = (0, _styledComponents['default'])(
  _Box.Box,
).withConfig({
...
var Message = function Message(_ref) {
  ...
  if (message) {
    ...
    if (typeof message === 'string')
      messageContent = /*#__PURE__*/ _react['default'].createElement(
        _Text.Text,
        rest,
        message,
      );
...
var FormField = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref3, ref) {
  ...
  var wantContentPad =
    ...
    (component === _CheckBox.CheckBox ||
      ...
      component === _RadioButtonGroup.RadioButtonGroup);
  var contents =
    (themeBorder &&
      children &&
  ...
  if (!themeBorder) {
    contents = /*#__PURE__*/ _react['default'].createElement(
      _Box.Box,
      _extends({}, themeContentProps, contentProps),
      contents,
    );
  }
  ...
  if (themeBorder) {
    ...
    contents = /*#__PURE__*/ _react['default'].createElement(
      FormFieldContentBox,
      _extends({}, themeContentProps, innerProps, contentProps),
      contents,
    );
  ...
  if (requiredIndicator === true)
    ...
    requiredIndicator = /*#__PURE__*/ _react['default'].createElement(
      _Text.Text,
      {
        a11yTitle: 'required',
      },
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    _extends(
      {
        ...
        margin: abut
          ? abutMargin
          : margin || _extends({}, formFieldTheme.margin),
      },
      outerProps,
      {
        style: outerStyle,
    ...
    (label && component !== _CheckBox.CheckBox) || help
      ? /*#__PURE__*/ _react['default'].createElement(
