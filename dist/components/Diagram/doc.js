...
var doc = function doc(Diagram) {
  var DocumentedDiagram = (0, _reactDesc.describe)(Diagram)
    .availableAt((0, _mixins.getAvailableAtBadge)('Diagram', 'Visualizations'))
    .description(
  ...
  DocumentedDiagram.propTypes = {
    connections: _reactDesc.PropTypes.arrayOf(
      _reactDesc.PropTypes.shape({
        anchor: _reactDesc.PropTypes.oneOf([
          'center',
          'vertical',
          'horizontal',
        ]),
        color: _propTypes.colorPropType,
        fromTarget: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.string,
          _reactDesc.PropTypes.object,
        ]).isRequired,
        label: _reactDesc.PropTypes.string,
        // for accessibility
        offset: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(['xsmall', 'small', 'medium', 'large']),
          _reactDesc.PropTypes.string,
        ]),
        ...
        toTarget: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.string,
          _reactDesc.PropTypes.object,
        ]).isRequired,
