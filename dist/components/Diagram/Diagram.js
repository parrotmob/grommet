...
var Diagram = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var placeConnections = (0, _react.useCallback)(
    function() {
  ...
  if (connectionPoints) {
    paths = connections.map(function(_ref3, index) {
      var anchor = _ref3.anchor,
        ...
        type = _ref3.type,
        connectionRest = _objectWithoutPropertiesLoose(_ref3, [
          'anchor',
          'color',
          'offset',
          'round',
      ...
      if (points) {
        var offsetWidth = offset
          ? (0, _utils.parseMetricToNum)(theme.global.edgeSize[offset])
          : 0;
        var d = COMMANDS[type || 'curved'](
          points[0],
          points[1],
          offsetWidth,
          anchor,
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement('g', null, paths),
  );
});
