...
var doc = function doc(Avatar) {
  var DocumentedAvatar = (0, _reactDesc.describe)(Avatar)
    .availableAt((0, _mixins.getAvailableAtBadge)('Avatar', 'Visualizations'))
    .description('An Avatar.')
    .usage("import { Avatar } from 'grommet';\n<Avatar/>")
  ...
  DocumentedAvatar.propTypes = {
    size: _reactDesc.PropTypes.oneOfType([
      ...
      .defaultValue('medium'),
    src: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.string,
    ]).description('Specifies a URL string for an avatar image.'),
  };
