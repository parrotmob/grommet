...
var doc = function doc(TextArea) {
  var DocumentedTextArea = (0, _reactDesc.describe)(TextArea)
    .availableAt((0, _mixins.getAvailableAtBadge)('TextArea', 'Input'))
  ...
  DocumentedTextArea.propTypes = {
    ...
    placeholder: _reactDesc.PropTypes.string.description(
    ...
    value: _reactDesc.PropTypes.string.description(
      'What text to put in the textarea.',
    ),
    resize: _reactDesc.PropTypes.oneOfType([
