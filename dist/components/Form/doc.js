...
var doc = function doc(Form) {
  var DocumentedForm = (0, _reactDesc.describe)(Form)
    .availableAt((0, _mixins.getAvailableAtBadge)('Form', 'Input'))
  ...
  DocumentedForm.propTypes = {
    ...
    onSubmit: _reactDesc.PropTypes.func.description(
    ...
    validate: _reactDesc.PropTypes.oneOf(['blur', 'submit', 'change'])
      .description('When to perform validation')
      .defaultValue('submit'),
    value: _reactDesc.PropTypes.shape({})
