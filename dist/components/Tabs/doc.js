...
var doc = function doc(Tabs) {
  var DocumentedTabs = (0, _reactDesc.describe)(Tabs)
    .availableAt((0, _mixins.getAvailableAtBadge)('Tabs', 'Controls'))
  ...
  DocumentedTabs.propTypes = _extends({}, _propTypes.genericProps, {
    activeIndex: _reactDesc.PropTypes.number.description(
    ...
    alignControls: _reactDesc.PropTypes.oneOf([
      'start',
      'center',
      'end',
      'stretch',
    ...
    justify: _reactDesc.PropTypes.oneOf(['start', 'center', 'end'])
