  ...
  tab: {
    ...
    extend: function extend(_ref2) {
      ...
      return (0, _styledComponents.css)([
        'border-radius:4px;box-shadow:0px 1px 5px rgba(0,0,0,0.5);',
      ]);
    },
  },
  tabs: {
    ...
    header: {
      ...
      extend: function extend(_ref3) {
        ...
        return (0, _styledComponents.css)([
          'padding:10px;box-shadow:0px 3px 8px rgba(0,0,0,0.50);',
        ]);
      },
    },
    panel: {
      extend: function extend(_ref4) {
        ...
        return (0, _styledComponents.css)([
          'padding:48px;box-shadow:0px 3px 8px rgba(0,0,0,0.50);',
        ]);
      },
    },
  },
        ...
        _grommet.Tab,
        {
          title: /*#__PURE__*/ _react['default'].createElement(RichTabTitle, {
            icon: /*#__PURE__*/ _react['default'].createElement(
              _grommetIcons.CircleInformation,
              {
                color: 'accent-1',
              },
            ),
