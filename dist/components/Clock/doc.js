...
var doc = function doc(Clock) {
  var DocumentedClock = (0, _reactDesc.describe)(Clock)
    .availableAt((0, _mixins.getAvailableAtBadge)('Clock', 'Visualization'))
  ...
  DocumentedClock.propTypes = _extends({}, _propTypes.genericProps, {
    hourLimit: _reactDesc.PropTypes.oneOf([12, 24, '12', '24'])
    ...
    precision: _reactDesc.PropTypes.oneOf(['hours', 'minutes', 'seconds'])
      .description('How precise a time to represent.')
      .defaultValue('seconds'),
    run: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf(['backward', 'forward']),
    ])
      .description(
    ...
    size: _reactDesc.PropTypes.oneOfType([
      ...
      .defaultValue('medium'),
    time: _reactDesc.PropTypes.string.description(
    ...
    type: _reactDesc.PropTypes.oneOf(['analog', 'digital'])
