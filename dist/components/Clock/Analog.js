...
var Analog = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref2, ref) {
  ...
  if (precision === 'seconds') {
    secondHand = /*#__PURE__*/ _react['default'].createElement(
      _StyledClock.StyledSecond,
      {
        x1: halfSize,
        y1: halfSize,
        x2: halfSize,
  ...
  if (precision === 'seconds' || precision === 'minutes') {
    minuteHand = /*#__PURE__*/ _react['default'].createElement(
      _StyledClock.StyledMinute,
      {
        x1: halfSize,
        y1: halfSize,
        x2: halfSize,
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    secondHand,
    minuteHand,
    /*#__PURE__*/ _react['default'].createElement(_StyledClock.StyledHour, {
      x1: halfSize,
      y1: halfSize,
      x2: halfSize,
      y2: hourSize,
