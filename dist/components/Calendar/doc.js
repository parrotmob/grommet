...
var doc = function doc(Calendar) {
  var DocumentedCalendar = (0, _reactDesc.describe)(Calendar)
    .availableAt((0, _mixins.getAvailableAtBadge)('Calendar', 'Visualizations'))
    .description(
  ...
  DocumentedCalendar.propTypes = _extends({}, _propTypes.genericProps, {
    activeDate: _reactDesc.PropTypes.oneOf(['start', 'end'])
      .description(
    ...
    date: _reactDesc.PropTypes.string.description(
      'The selected date in ISO8601 format',
    ),
    dates: _reactDesc.PropTypes.arrayOf(
    ...
    disabled: _reactDesc.PropTypes.arrayOf(
      _reactDesc.PropTypes.oneOfType([
        _reactDesc.PropTypes.string,
        _reactDesc.PropTypes.arrayOf(_reactDesc.PropTypes.string),
      ]),
    ...
    locale: _reactDesc.PropTypes.string
    ...
    range: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf(['array']),
    ])
      .description(
      ...
      .defaultValue(false),
    reference: _reactDesc.PropTypes.string.description(
      "The date to show if `date` isn't set, in ISO8601 format",
    ),
    showAdjacentDays: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf(['trim']),
    ])
      .description(
    ...
    size: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['small', 'medium', 'large']),
      _reactDesc.PropTypes.string,
    ])
...
var themeDoc = _extends(
  ...
  _themeDocUtils.themeDocUtils.iconColor,
