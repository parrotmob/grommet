...
var normalizeForTimezone = function normalizeForTimezone(date, refDate) {
  ...
  return (!timeStamp.test(refDate || date)
    ? (0, _utils.localTimezoneToUTC)(new Date(date))
    : new Date(date)
  ).toISOString();
};
...
var buildDisplayBounds = function buildDisplayBounds(
  reference,
  firstDayOfWeek,
) {
  ...
  start =
    start.getDay() === 0 && firstDayOfWeek === 1
      ? (start = (0, _utils.subtractDays)(start, 6)) // beginning of week
      : (start = (0, _utils.subtractDays)(
          start,
          start.getDay() - firstDayOfWeek,
        ));
...
var Calendar = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref3, ref) {
  var activeDateProp = _ref3.activeDate,
    ...
    showAdjacentDays =
      _ref3$showAdjacentDay === void 0 ? true : _ref3$showAdjacentDay,
  ...
  var theme =
    ...
    _defaultProps.defaultProps.theme; // set activeDate when caller changes it, allows us to change
  // it internally too
  ...
  (0, _react.useEffect)(
    function() {
      return setReference(
        normalizeReference(referenceProp, dateProp, datesProp),
      );
    },
  ...
  var previousMonth = (0, _react.useMemo)(
    function() {
      return (0, _utils.endOfMonth)(
        (0, _utils.subtractMonths)((0, _utils.startOfMonth)(reference), 1),
      );
    },
    [reference],
  );
  var nextMonth = (0, _react.useMemo)(
    function() {
      return (0, _utils.startOfMonth)(
        (0, _utils.addMonths)((0, _utils.startOfMonth)(reference), 1),
      );
    },
    [reference],
  );
  ...
  var changeReference = (0, _react.useCallback)(
  ...
  var selectDate = (0, _react.useCallback)(
  ...
  while (day.getTime() < displayBounds[1].getTime()) {
    ...
    we know that all days in the array are from the next month. */
      ...
      (function() {
        ...
        var dayDisabled =
          (0, _utils.withinDates)(day, disabled) ||
          (bounds && !(0, _utils.betweenDates)(day, bounds));
        ...
        /*#__PURE__*/ _react['default'].createElement(
          _StyledCalendar.StyledWeeksContainer,
          {
            ...
            onFocus: function onFocus() {
              ...
              if (
                date &&
                (0, _utils.betweenDates)(new Date(date), displayBounds)
              ) {
