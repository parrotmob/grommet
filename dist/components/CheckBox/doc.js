...
var doc = function doc(CheckBox) {
  var DocumentedCheckBox = (0, _reactDesc.describe)(CheckBox)
    .availableAt((0, _mixins.getAvailableAtBadge)('CheckBox', 'Input'))
  ...
  DocumentedCheckBox.propTypes = {
    ...
    checked: _reactDesc.PropTypes.bool
    ...
    reverse: _reactDesc.PropTypes.bool
      ...
      .defaultValue(false),
    toggle: _reactDesc.PropTypes.bool
      .description('Whether to visualize it as a toggle switch.')
      .defaultValue(false),
    indeterminate: _reactDesc.PropTypes.bool
      .description(
