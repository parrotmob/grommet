...
var doc = function doc(Button) {
  var DocumentedButton = (0, _reactDesc.describe)(Button)
    .availableAt((0, _mixins.getAvailableAtBadge)('Button', 'Controls'))
  ...
  DocumentedButton.propTypes = _extends({}, _propTypes.genericProps, {
    children: _reactDesc.PropTypes.oneOfType([
    ...
    active: _reactDesc.PropTypes.bool
    ...
    color: _propTypes.colorPropType.description(
    ...
    hoverIndicator: _propTypes.hoverIndicatorPropType
      ...
      .defaultValue(false),
    href: _reactDesc.PropTypes.string.description(
    ...
    label: _reactDesc.PropTypes.node.description(
    ...
    primary: _reactDesc.PropTypes.bool
      ...
      .defaultValue(false),
    reverse: _reactDesc.PropTypes.bool
      .description(
        'Whether an icon and label should be reversed so that the icon is at the\n              end of the anchor.',
      )
      .defaultValue(false),
    secondary: _reactDesc.PropTypes.bool.description(
      'Whether this is a secondary button.',
    ),
    size: _reactDesc.PropTypes.oneOf(['small', 'medium', 'large']).description(
    ...
    target: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['_self', '_blank', '_parent', '_top']),
      _reactDesc.PropTypes.string,
    ]).description(
      'Specifies where to display the URL defined in the href property.',
    ),
    tip: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.shape({
        content: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.node,
          _reactDesc.PropTypes.string,
        ]),
    ...
    type: _reactDesc.PropTypes.oneOf(['button', 'reset', 'submit'])
      .description(
