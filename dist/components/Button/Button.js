    ...
    if (obj) {
      ...
      var background =
        colorProp && obj.background && obj.background.color
          ? colorProp
          : obj.background; // if theme object explicitly sets the color to undefined, pass false
      ...
      var objColor =
        ...
        obj.color === undefined
          ? false
          : undefined); // use passed in color for text if the theme doesn't have
...
var Button = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  var a11yTitle = _ref.a11yTitle,
    ...
    focusIndicator =
      _ref$focusIndicator === void 0 ? true : _ref$focusIndicator,
    _ref$gap = _ref.gap,
  ...
  var themePaths = (0, _react.useMemo)(
    function() {
  ...
  var isDarkBackground = function isDarkBackground() {
    var backgroundColor = (0, _utils.normalizeBackground)(
  ...
  if (kind) {
    styledButtonResult = /*#__PURE__*/ _react['default'].createElement(
      _StyledButtonKind.StyledButtonKind,
      _extends({}, rest, {
        as: domTag,
        ref: ref,
        active: active,
      ...
      _extends({}, rest, {
        ...
        plain:
          typeof plain !== 'undefined'
            ? plain
            : _react.Children.count(children) > 0 || (icon && !label),
        primary: primary,
        sizeProp: size,
        type: !href ? type : undefined,
      }),
