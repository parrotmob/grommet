...
var basicStyle = function basicStyle(props) {
  return (0, _styledComponents.css)(
    ['border:none;', ';', ' ', ' > svg{vertical-align:bottom;}'],
    radiusStyle(props),
    padStyle(props),
    fontStyle(props),
  );
...
var adjustPadStyle = function adjustPadStyle(pad, width) {
  ...
  return (0, _styledComponents.css)(
    ['padding:', 'px ', 'px;'],
    Math.max((0, _utils.parseMetricToNum)(pad.vertical) - offset, 0),
    Math.max((0, _utils.parseMetricToNum)(pad.horizontal) - offset, 0),
  );
...
var hoverIndicatorStyle = function hoverIndicatorStyle(_ref3) {
  ...
  if (styles.length > 0)
    return (0, _styledComponents.css)(['&:hover{', '}'], styles);
  return '';
};
...
var plainStyle = function plainStyle() {
  return (0, _styledComponents.css)([
    'outline:none;border:none;padding:0;text-align:inherit;color:inherit;> svg{vertical-align:bottom;}',
  ]);
};

var StyledButtonKind = _styledComponents['default'].button
  .withConfig({
  ...
  function(props) {
    return (
      props.disabled &&
      (0, _utils.disabledStyle)(props.theme.button.disabled.opacity)
    );
  },
  function(props) {
  ...
  function(props) {
    return (
      ...
      '\n    transition-property: ' +
        props.theme.button.transition.properties.join(',') +
        ';\n    transition-duration: ' +
        props.theme.button.transition.duration +
        's;\n    transition-timing-function: ' +
        props.theme.button.transition.timing +
        ';\n  '
    );
  },
  function(props) {
