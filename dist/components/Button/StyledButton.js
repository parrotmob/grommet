...
var basicStyle = function basicStyle(props) {
  return (0, _styledComponents.css)(
    ['border:', ' solid ', ';border-radius:', ';color:', ';padding:', ';', ''],
    ...
    radiusStyle(props),
    (0, _utils.normalizeColor)(props.theme.button.color || 'text', props.theme),
    padStyle(props),
    fontStyle(props),
  );
};
  ...
  return (0, _styledComponents.css)(
    ...
    !props.plain &&
      ...
      'border: ' +
        ...
        ';',
    props.theme.button.disabled.color && // if primary button, apply disabled color to background. otherwise,
