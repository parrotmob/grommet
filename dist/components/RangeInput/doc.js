...
var doc = function doc(RangeInput) {
  var DocumentedRangeInput = (0, _reactDesc.describe)(RangeInput)
    .availableAt((0, _mixins.getAvailableAtBadge)('RangeInput', 'Input'))
  ...
  DocumentedRangeInput.propTypes = {
    ...
    step: _reactDesc.PropTypes.number.description(
