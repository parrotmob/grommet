...
var getBoundColor = function getBoundColor(props, bound) {
  ...
  return (0, _polished.rgba)(
    (0, _utils.normalizeColor)(props.theme.rangeInput.track.color, props.theme),
    getBoundOpacity(props, bound),
  );
};
...
var rangeTrackStyle = (0, _styledComponents.css)(
...
var rangeThumbStyle = (0, _styledComponents.css)(
  [
    'box-sizing:border-box;position:relative;border-radius:',
    ';height:',
    ';width:',
    ';overflow:visible;background:',
...
var firefoxMicrosoftThumbStyle = (0, _styledComponents.css)(
  ['', ' margin-top:0px;height:', ';width:', ';', ''],
  rangeThumbStyle,
  function(props) {
    return props.theme.global.spacing;
  },
...
var StyledRangeInput = _styledComponents['default'].input.withConfig({
  ...
  [
    'box-sizing:border-box;position:relative;-webkit-appearance:none;border-color:transparent;height:',
    ';width:100%;padding:0px;cursor:pointer;background:transparent;&::-moz-focus-inner{border:none;}&::-moz-focus-outer{border:none;}&::-webkit-slider-runnable-track{',
    '}&::-webkit-slider-thumb{margin-top:-',
    'px;',
    ' ',
    '}&::-moz-range-track{',
    '}&::-moz-range-thumb{',
    ...
    '}',
    ' &::-ms-track{',
    ' border-color:transparent;color:transparent;}&::-ms-fill-lower{',
    ';border-color:transparent;}&::-ms-fill-upper{',
  ...
  function(props) {
    return (
      ((0, _utils.parseMetricToNum)(props.theme.global.spacing) -
        (0, _utils.parseMetricToNum)(
          props.theme.rangeInput.track.height || 0,
        )) *
      0.5
    );
  },
  ...
  function(props) {
    return (
      ...
      (0, _styledComponents.css)(
        [
          '&:hover::-moz-range-thumb{box-shadow:0px 0px 0px 2px ',
          ';}&:hover::-ms-thumb{box-shadow:0px 0px 0px 2px ',
          ';}',
        ],
        (0, _utils.normalizeColor)(
          props.theme.rangeInput.thumb.color || 'control',
