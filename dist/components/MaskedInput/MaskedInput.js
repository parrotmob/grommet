...
var parseValue = function parseValue(mask, value) {
  ...
  while (
    ...
    if (item.fixed) {
      ...
      found = item.options
        .slice(0)
        .reverse() // eslint-disable-next-line no-loop-func
    ...
    if (!found) {
      if (item.regexp) {
        ...
        var _length2 = Array.isArray(item.length)
          ? item.length[1]
...
var MaskedInput = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var setInputValue = (0, _react.useCallback)(
    function(nextValue) {
  ...
  var onChangeInput = (0, _react.useCallback)(
    function(event) {
      // Align with the mask.
      var nextValueParts = parseValue(mask, event.target.value);
      var nextValue = nextValueParts
        .map(function(part) {
          return part.part;
        })
        .join('');
  ...
  var onOption = (0, _react.useCallback)(
    function(option) {
      return function() {
  ...
  var onEsc = (0, _react.useCallback)(
    function(event) {
      if (showDrop) {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    _StyledMaskedInput.StyledMaskedInputContainer,
    {
      plain: plain,
    },
    icon &&
      /*#__PURE__*/ _react['default'].createElement(
        _StyledMaskedInput.StyledIcon,
        {
          reverse: reverse,
          theme: theme,
        },
    ...
    /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ _react['default'].createElement(
        _StyledMaskedInput.StyledMaskedInput,
        _extends(
          {
            ref: inputRef,
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          mask[activeMaskIndex].options.map(function(option, index) {
            ...
            var child = !theme.button.option
              ...
              : undefined; // if we have a child, turn on plain, and hoverIndicator
