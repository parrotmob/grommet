...
var doc = function doc(MaskedInput) {
  var DocumentedMaskedInput = (0, _reactDesc.describe)(MaskedInput)
    .availableAt((0, _mixins.getAvailableAtBadge)('MaskedInput', 'Input'))
  ...
  DocumentedMaskedInput.propTypes = {
    ...
    onBlur: _reactDesc.PropTypes.func.description(
      'Function that will be called when the user leaves the field.',
    ),
    mask: _reactDesc.PropTypes.arrayOf(
      _reactDesc.PropTypes.shape({
        length: _reactDesc.PropTypes.oneOfType([
