...
var doc = function doc(InfiniteScroll) {
  var DocumentedInfiniteScroll = (0, _reactDesc.describe)(InfiniteScroll)
    .availableAt(
      (0, _mixins.getAvailableAtBadge)('InfiniteScroll', 'Utilities'),
    )
    .description('A container that lazily renders items.')
    .usage("import { InfiniteScroll } from 'grommet';\n<InfiniteScroll />");
  DocumentedInfiniteScroll.propTypes = {
    ...
    items: _reactDesc.PropTypes.arrayOf(_reactDesc.PropTypes.any).description(
    ...
    renderMarker: _reactDesc.PropTypes.func.description(
    ...
    replace: _reactDesc.PropTypes.bool
      ...
      .defaultValue(false),
    scrollableAncestor: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.node,
      _reactDesc.PropTypes.oneOf(['window']),
    ]).description(
    ...
    show: _reactDesc.PropTypes.number.description(
