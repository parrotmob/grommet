...
var InfiniteScroll = function InfiniteScroll(_ref) {
  ...
  var _useState = (0, _react.useState)(showProp),
    show = _useState[0],
    setShow = _useState[1]; // the last page we have items for

  var lastPage = (0, _react.useMemo)(
    function() {
  ...
  var belowMarkerRef = (0, _react.useRef)(); // scroll and resize handling
    ...
    function() {
      ...
      var timer = setTimeout(function() {
        if (show && belowMarkerRef.current) {
          ...
          var showNode = belowMarkerRef.current.parentNode.children.item(
            showIndex,
          );
    ...
    function() {
      ...
      if (
        ...
        while (i <= renderPageBounds[1]) {
          ...
          var _rendered$item$getBou = rendered
              .item(bottomIndex)
  ...
  var aboveHeight = (0, _react.useMemo)(
    function() {
      if (!replace) return 0;
      var height = 0;
      var i = 0;
  ...
  var belowHeight = (0, _react.useMemo)(
    function() {
      if (!replace) return 0;
      var height = 0;
  ...
  if (aboveHeight) {
    ...
    if (renderMarker) {
      ...
      marker = /*#__PURE__*/ _react['default'].cloneElement(
        renderMarker(marker),
        {
          key: 'above',
        },
