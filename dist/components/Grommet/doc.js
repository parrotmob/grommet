...
var doc = function doc(Grommet) {
  var DocumentedGrommet = (0, _reactDesc.describe)(Grommet)
    .availableAt((0, _mixins.getAvailableAtBadge)('Grommet', 'Utilities'))
  ...
  DocumentedGrommet.propTypes = {
    ...
    dir: _reactDesc.PropTypes.oneOf(['rtl']).description(
      'Layout direction for right to left contexts',
    ),
    full: _reactDesc.PropTypes.bool
    ...
    plain: _reactDesc.PropTypes.bool
      ...
      .defaultValue(false),
    cssVars: _reactDesc.PropTypes.bool
      .description('Whether to expose the css variables.')
      .defaultValue(false),
    theme: _reactDesc.PropTypes.object.description(
      'Custom styles for Grommet app component.',
    ),
    themeMode: _reactDesc.PropTypes.oneOf(['dark', 'light']).description(
      'Dark vs. light theme variation. Default is unspecified and left to\n      theme.',
    ),
    userAgent: _reactDesc.PropTypes.string.description(
      'User agent used to detect the device width for setting the initial\n      breakpoint.',
    ),
    containerTarget: _reactDesc.PropTypes.object.description(
