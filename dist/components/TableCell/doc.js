...
var doc = function doc(TableCell) {
  var DocumentedTableCell = (0, _reactDesc.describe)(TableCell)
  ...
  DocumentedTableCell.propTypes = {
    plain: _reactDesc.PropTypes.bool
      ...
      .defaultValue(false),
    scope: _reactDesc.PropTypes.oneOf(['col', 'row']).description(
    ...
    verticalAlign: _reactDesc.PropTypes.oneOf([
      'top',
      'middle',
      'bottom',
    ]).description('How to align the contents vertically.'),
    align: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf([
        'left',
        'right',
        'center',
