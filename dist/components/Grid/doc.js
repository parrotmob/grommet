...
var doc = function doc(Grid) {
  var DocumentedGrid = (0, _reactDesc.describe)(Grid)
    .availableAt((0, _mixins.getAvailableAtBadge)('Grid', 'Layout'))
    .description(
  ...
  DocumentedGrid.propTypes = _extends({}, _propTypes.genericProps, {
    align: _reactDesc.PropTypes.oneOf(['start', 'center', 'end', 'stretch'])
      .description(
    ...
    areas: _reactDesc.PropTypes.oneOfType([
    ...
    columns: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.arrayOf(
      ...
      _reactDesc.PropTypes.oneOf(fixedSizes),
      _reactDesc.PropTypes.shape({
        count: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(['fit', 'fill']),
    ...
    gap: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(edgeSizes),
      _reactDesc.PropTypes.shape({
        row: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(edgeSizes),
          _reactDesc.PropTypes.string,
        ]),
        column: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(edgeSizes),
          _reactDesc.PropTypes.string,
        ]),
      }),
    ...
    justify: _reactDesc.PropTypes.oneOf(['start', 'center', 'end', 'stretch'])
      .description(
        'How to align the individual items inside the grid when there is extra\nspace in the row axis.',
      )
      .defaultValue('stretch'),
    justifyContent: _reactDesc.PropTypes.oneOf([
      'start',
      'center',
      'end',
      'between',
    ...
    responsive: _reactDesc.PropTypes.bool
      ...
      .defaultValue(true),
    rows: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.arrayOf(
        _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.arrayOf(
            _reactDesc.PropTypes.oneOfType([
