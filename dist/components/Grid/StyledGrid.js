...
var justifyStyle = (0, _styledComponents.css)(['justify-items:', ';'], function(
  props,
) {
...
var justifyContentStyle = (0, _styledComponents.css)(
  ['justify-content:', ';'],
  function(props) {
...
var gapStyle = function gapStyle(props) {
  ...
  if (props.gap.row && props.gap.column) {
    return (
      '\n      grid-row-gap: ' +
      (props.theme.global.edgeSize[props.gap.row] || props.gap.row) +
      ';\n      grid-column-gap: ' +
      ...
      props.rowsProp
        .map(function(s) {
          if (Array.isArray(s)) {
            return (
              'minmax(' +
              sizeFor(s[0], props, true) +
              ', ' +
              sizeFor(s[1], props, true) +
              ')'
            );
          }
...
var areasStyle = function areasStyle(props) {
  ...
  if (
    ...
    props.areas.every(function(area) {
...
var StyledGrid = _styledComponents['default'].div
