...
var doc = function doc(FileInput) {
  var DocumentedFileInput = (0, _reactDesc.describe)(FileInput)
    .availableAt((0, _mixins.getAvailableAtBadge)('FileInput', 'Input'))
  ...
  DocumentedFileInput.propTypes = {
    ...
    multiple: _reactDesc.PropTypes.oneOfType([
    ...
    renderFile: _reactDesc.PropTypes.node.description(
