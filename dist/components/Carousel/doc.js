...
var doc = function doc(Carousel) {
  var DocumentedCarousel = (0, _reactDesc.describe)(Carousel)
    .availableAt((0, _mixins.getAvailableAtBadge)('Carousel', 'Media'))
    .description(
  ...
  DocumentedCarousel.propTypes = _extends({}, _propTypes.genericProps, {
    fill: _reactDesc.PropTypes.bool.description(
      'Whether to expand to fill\n      all of the available width and height in the parent container.',
    ),
    play: _reactDesc.PropTypes.number.description(
