...
var doc = function doc(Markdown) {
  var DocumentedMarkdown = (0, _reactDesc.describe)(Markdown)
    .availableAt((0, _mixins.getAvailableAtBadge)('Markdown', 'Type'))
  ...
  DocumentedMarkdown.propTypes = {
    components: _reactDesc.PropTypes.object.description(
    ...
    options: _reactDesc.PropTypes.shape({}).description(
