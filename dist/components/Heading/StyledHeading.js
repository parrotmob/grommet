...
var sizeStyle = function sizeStyle(props) {
  ...
  if (levelStyle) {
    ...
    var styles = [
      (0, _styledComponents.css)(
        ...
        data ? data.size : size,
        data ? data.height : 'normal',
        (props.fillProp && 'none') ||
          (data && data.maxWidth) ||
          levelStyle.medium.maxWidth,
        levelStyle.font.weight || headingTheme.weight,
      ),
    ];
    ...
    if (props.responsive && headingTheme.responsiveBreakpoint) {
      ...
      if (breakpoint) {
        var responsiveData = headingTheme.level[props.level + 1]
          ...
          styles.push(
            (0, _utils.breakpointStyle)(
              ...
              '\n            font-size: ' +
                responsiveData.size +
                ';\n            line-height: ' +
                responsiveData.height +
                ';\n            max-width: ' +
                ((props.fillProp && 'none') || responsiveData.maxWidth) +
                ';\n          ',
            ),
          );
        }
  ...
  console.warn(
    'Heading level ' + props.level + ' is not defined in your theme.',
  );
  return '';
};
...
var colorStyle = (0, _styledComponents.css)(['color:', ';'], function(props) {
  return (0,
  _utils.normalizeColor)(props.colorProp || props.theme.heading.color, props.theme);
});
