...
var Spinner = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref2, ref) {
  ...
  (0, _react.useEffect)(
    function() {
      if (message != null && message.start) announce(message.start);
      else if (typeof message === 'string') announce(message);
      return function() {
        return (
          (message == null ? void 0 : message.end) && announce(message.end)
        );
      };
    },
    [announce, message],
  ...
  var _theme$spinner$contai = theme.spinner.container,
    ...
    themeProps = _objectWithoutPropertiesLoose(_theme$spinner$contai, [
      'size',
      'color',
    ]);
  ...
  if (Icon)
    return /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ (0, _react.isValidElement)(Icon)
        ? Icon
