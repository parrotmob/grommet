...
var Circle = /*#__PURE__*/ (0, _react.forwardRef)(function(props, ref) {
  ...
  var width =
    size === 'full'
      ? 288
      : (0, _utils.parseMetricToNum)(theme.global.size[size] || size);
  var height = (0, _utils.parseMetricToNum)(
  ...
  (values || [])
    ...
    .forEach(function(valueArg, index) {
      var color = valueArg.color,
        ...
        pathRest = _objectWithoutPropertiesLoose(valueArg, [
          'color',
          'highlight',
          'label',
          'onHover',
      ...
      var colorName =
        color ||
        (0, _utils2.defaultColor)(index, theme, values ? values.length : 0);
      var endAngle;
      ...
      if (startValue + value >= max) {
        ...
        endAngle = Math.min(
          360,
          (0, _utils.translateEndAngle)(startAngle, anglePer, value),
        );
      }
      ...
      var stroke = (0, _utils2.strokeProps)(
        someHighlight && !highlight ? background : colorName,
        theme,
      );

      if (round) {
        var d1 = (0, _utils.arcCommands)(
          width / 2,
          width / 2,
          radius,
          startAngle,
        ...
        var pathCap = /*#__PURE__*/ _react['default'].createElement(
          'path',
          _extends(
            {
              key: key + '-',
