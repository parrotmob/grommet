...
var doc = function doc(Meter) {
  var DocumentedMeter = (0, _reactDesc.describe)(Meter)
    .availableAt((0, _mixins.getAvailableAtBadge)('Meter', 'Visualizations'))
  ...
  DocumentedMeter.propTypes = _extends({}, _propTypes.genericProps, {
    ...
    thickness: _reactDesc.PropTypes.oneOfType([
      ...
      .description('The size of the Meter.')
      .defaultValue('medium'),
    type: _reactDesc.PropTypes.oneOf(['bar', 'circle'])
