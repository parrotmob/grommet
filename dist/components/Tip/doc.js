...
var doc = function doc(Tip) {
  var DocumentedTip = (0, _reactDesc.describe)(Tip)
    .availableAt((0, _mixins.getAvailableAtBadge)('Tip', 'Controls'))
    .description(
  ...
  DocumentedTip.propTypes = {
    content: _reactDesc.PropTypes.node.description(
      'The tooltip content inside the drop.',
    ),
    dropProps: _reactDesc.PropTypes.object
