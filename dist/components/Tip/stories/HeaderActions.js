...
var TipContent = function TipContent(_ref) {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    icon &&
      /*#__PURE__*/ _react['default'].createElement(_grommetIcons.Info, {
        color: 'accent-4',
      }),
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement('b', null, 'Follow'),
        ' the Tips of the Trash & Reload icons for directions. Those Tooltips ',
        /*#__PURE__*/ _react['default'].createElement('b', null, 'change'),
        ' according to the actions the user perform on the table. The Table meters are also using the Tip component.',
      ),
      /*#__PURE__*/ _react['default'].createElement(
        _grommet.Box,
        {
            ...
            /*#__PURE__*/ _react['default'].createElement(
              _grommet.Tip,
              {
                ...
                content: /*#__PURE__*/ _react['default'].createElement(
                  ...
                  {
                    message:
                      data.length < _data.storageData.length
                        ? 'Reload Data'
