...
var doc = function doc(Image) {
  var DocumentedImage = (0, _reactDesc.describe)(Image)
    .availableAt((0, _mixins.getAvailableAtBadge)('Image', 'Media'))
    .description('An image.')
    .usage("import { Image } from 'grommet';\n<Image/>")
    .intrinsicElement('img');
  DocumentedImage.propTypes = _extends({}, _propTypes.genericProps, {
    ...
    fallback: _reactDesc.PropTypes.string.description(
