...
var doc = function doc(List) {
  var DocumentedList = (0, _reactDesc.describe)(List)
    .availableAt((0, _mixins.getAvailableAtBadge)('List', 'Visualizations'))
  ...
  DocumentedList.propTypes = _extends({}, _propTypes.genericProps, {
    action: _reactDesc.PropTypes.func.description(
    ...
    as: _reactDesc.PropTypes.string
    ...
    border: _reactDesc.PropTypes.oneOfType(borderTypes).description(
      'Item border.',
    ),
    ...
    itemProps: _reactDesc.PropTypes.shape({}).description(
    ...
    onClickItem: _reactDesc.PropTypes.func.description(
    ...
    pad: _reactDesc.PropTypes.oneOfType([_propTypes.padPropType]).description(
      'Item padding.',
    ),
    ...
    secondaryKey: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.string,
      _reactDesc.PropTypes.func,
    ]).description(
