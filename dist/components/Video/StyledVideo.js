...
var fitStyle = (0, _styledComponents.css)(
  ['flex:1 1;min-height:0;object-fit:', ';'],
  function(props) {
...
var StyledVideo = _styledComponents['default'].video.withConfig({
  ...
  ['max-width:100%;z-index:1;', '::cue{background:', ';}', ';'],
  function(props) {
...
var positionStyle = (0, _styledComponents.css)([
...
var StyledVideoControls = _styledComponents['default'].div.withConfig({
  ...
  ['flex:0 0;', ' opacity:0;transition:opacity 0.3s;', ';'],
  function(props) {
...
var headStyle = (0, _styledComponents.css)(
  [
    "::after{content:'';height:100%;width:",
    ';background:',
  ...
  function(props) {
    return (0, _utils.normalizeColor)(
      props.theme.video.scrubber.color,
      props.theme,
    );
  },
  function(props) {
