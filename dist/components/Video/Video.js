...
var Video = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var play = (0, _react.useCallback)(
    function() {
      return videoRef.current.play();
    },
    [videoRef],
  );
  var pause = (0, _react.useCallback)(
    function() {
      return videoRef.current.pause();
    },
    [videoRef],
  );
  var scrub = (0, _react.useCallback)(
    function(event) {
  ...
  var louder = (0, _react.useCallback)(
    function() {
      videoRef.current.volume += VOLUME_STEP;
    },
    [videoRef],
  );
  var quieter = (0, _react.useCallback)(
    function() {
      videoRef.current.volume -= VOLUME_STEP;
    },
    [videoRef],
  ...
  var fullscreen = (0, _react.useCallback)(
    function() {
      var video = videoRef.current;
  ...
  if (controls) {
    ...
    var captionControls = captions.map(function(caption) {
      return {
        icon: caption.label
          ? undefined
          : /*#__PURE__*/ _react['default'].createElement(Icons.ClosedCaption, {
              color: iconColor,
            }),
        label: caption.label,
    ...
    controlsElement = /*#__PURE__*/ _react['default'].createElement(
      _StyledVideo.StyledVideoControls,
      {
        over: over,
        active: !hasPlayed || controls === 'below' || (over && interacting),
        onBlur: function onBlur() {
          if (!(0, _utils.containsFocus)(containerRef.current))
            setInteracting(false);
        },
      },
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(_Button.Button, {
          icon: playing
            ? /*#__PURE__*/ _react['default'].createElement(Icons.Pause, {
                color: iconColor,
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          /*#__PURE__*/ _react['default'].createElement(
            ...
            /*#__PURE__*/ _react['default'].createElement(
              _Stack.Stack,
              null,
              /*#__PURE__*/ _react['default'].createElement(_Meter.Meter, {
              ...
              /*#__PURE__*/ _react['default'].createElement(
                _StyledVideo.StyledVideoScrubber,
                {
