...
var doc = function doc(Video) {
  var DocumentedVideo = (0, _reactDesc.describe)(Video)
    .availableAt((0, _mixins.getAvailableAtBadge)('Video', 'Media'))
  ...
  DocumentedVideo.propTypes = _extends({}, _propTypes.genericProps, {
    autoPlay: _reactDesc.PropTypes.bool.description(
      'Enables automatic playback of the video as soon as it is loaded.',
    ),
    controls: _reactDesc.PropTypes.oneOf([false, 'over', 'below'])
      .description('Whether to show playback controls and where to place them.')
      .defaultValue('over'),
    fit: _reactDesc.PropTypes.oneOf(['cover', 'contain']).description(
      'How the image fills its container.',
    ),
    loop: _reactDesc.PropTypes.bool.description(
      'Enables continuous video looping.',
    ),
    mute: _reactDesc.PropTypes.bool.description(
...
var themeDoc = _extends(
  {},
  _themeDocUtils.themeDocUtils.responsiveBreakpoint(
