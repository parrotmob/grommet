...
var doc = function doc(Layer) {
  var DocumentedLayer = (0, _reactDesc.describe)(Layer)
    .availableAt((0, _mixins.getAvailableAtBadge)('Layer', 'Layout'))
    .description(
  ...
  DocumentedLayer.propTypes = {
    animate: _reactDesc.PropTypes.bool
      .description(
    ...
    animation: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['slide', 'fadeIn', 'none']),
    ...
    full: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf(['vertical', 'horizontal']),
    ])
      .description(
        'Whether the width and/or height should fill the current viewport\n        size.',
      )
      .defaultValue(false),
    margin: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['none'].concat(PAD_SIZES)),
      _reactDesc.PropTypes.shape({
        bottom: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
        end: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
        horizontal: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
        left: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
        right: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
        start: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
        top: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
        vertical: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(PAD_SIZES),
          _reactDesc.PropTypes.string,
        ]),
      }),
    ...
    plain: _reactDesc.PropTypes.bool
      ...
      .defaultValue(false),
    position: _reactDesc.PropTypes.oneOf([
      'bottom',
      'bottom-left',
      'bottom-right',
      'center',
    ...
    responsive: _reactDesc.PropTypes.bool
      ...
      .defaultValue(true),
    target: _reactDesc.PropTypes.object.description(
