...
var Layer = /*#__PURE__*/ (0, _react.forwardRef)(function(props, ref) {
  ...
  var containerTarget = (0, _react.useContext)(
    _ContainerTargetContext.ContainerTargetContext,
  );
  (0, _react.useEffect)(
    function() {
      return setLayerContainer(
        (0, _utils.getNewContainer)(containerTarget, targetChildPosition),
      );
    },
      ...
      return function() {
        ...
        if (layerContainer) {
          ...
          if (activeAnimation !== false) {
            ...
            var clonedContainer = layerClone.querySelector(
