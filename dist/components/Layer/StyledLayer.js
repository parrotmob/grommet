...
var hiddenPositionStyle = (0, _styledComponents.css)([
  'left:-100%;right:100%;z-index:-1;position:fixed;',
]);
...
var StyledLayer = _styledComponents['default'].div.withConfig({
  ...
  [
    '',
    ' background:transparent;position:relative;z-index:',
  ...
  function(props) {
    ...
    if (
      ...
      styles.push(
        (0, _utils.breakpointStyle)(breakpoint, responsiveLayerStyle),
      );
    }
...
var getMargin = function getMargin(margin, theme, position) {
  ...
  return !marginInTheme && typeof marginValue !== 'string'
    ? 0
    : (0, _utils.parseMetricToNum)(marginApplied);
};
...
var KEYFRAMES = {
  center: {
    vertical: (0, _styledComponents.keyframes)([
      '0%{transform:translateX(-50%) scale(0.8);}100%{transform:translateX(-50%) scale(1);}',
    ]),
    horizontal: (0, _styledComponents.keyframes)([
      '0%{transform:translateY(-50%) scale(0.8);}100%{transform:translateY(-50) scale(1);}',
    ]),
    true: (0, _styledComponents.keyframes)([
      '0%{transform:scale(0.8);}100%{transform:scale(1);}',
    ]),
    false: (0, _styledComponents.keyframes)([
      '0%{transform:translate(-50%,-50%) scale(0.8);}100%{transform:translate(-50%,-50%) scale(1);}',
    ]),
  },
  top: {
    vertical: (0, _styledComponents.keyframes)([
      '0%{transform:translate(-50%,-100%);}100%{transform:translate(-50%,0);}',
    ]),
    horizontal: (0, _styledComponents.keyframes)([
  ...
  left: {
    ...
    horizontal: (0, _styledComponents.keyframes)([
      '0%{transform:translate(-100%,-50%);}100%{transform:translate(0,-50%);}',
    ]),
    true: (0, _styledComponents.keyframes)([
      '0%{transform:translateX(-100%);}100%{transform:translateX(0);}',
    ]),
...
var POSITIONS = {
  center: {
    vertical: function vertical(bounds) {
      return (0, _styledComponents.css)(
        ['top:', 'px;bottom:', 'px;left:50%;transform:translateX(-50%);', ''],
        bounds.top,
        bounds.bottom,
        function(props) {
    ...
    horizontal: function horizontal(bounds) {
      return (0, _styledComponents.css)(
        ['left:', 'px;right:', 'px;top:50%;transform:translateY(-50%);', ''],
        bounds.left,
        bounds.right,
        function(props) {
  ...
  top: {
    vertical: function vertical(bounds) {
      return (0, _styledComponents.css)(
        ['top:', 'px;bottom:', 'px;left:50%;transform:translate(-50%,0%);', ''],
        bounds.top,
        bounds.bottom,
        function(props) {
    ...
    horizontal: function horizontal(bounds) {
      return (0, _styledComponents.css)(
        ['left:', 'px;right:', 'px;top:', 'px;transform:translateY(0);', ''],
        bounds.left,
        bounds.right,
        bounds.top,
        function(props) {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['top:', 'px;left:50%;transform:translate(-50%,0);', ''],
        bounds.top,
        function(props) {
  ...
  bottom: {
    ...
    horizontal: function horizontal(bounds) {
      return (0, _styledComponents.css)(
        ['left:', 'px;right:', 'px;bottom:', 'px;transform:translateY(0);', ''],
        bounds.left,
        bounds.top,
        bounds.bottom,
        function(props) {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['bottom:', 'px;left:50%;transform:translate(-50%,0);', ''],
        bounds.bottom,
        function(props) {
  ...
  left: {
    vertical: function vertical(bounds) {
      return (0, _styledComponents.css)(
        ['top:', 'px;bottom:', 'px;left:', 'px;transform:translateX(0);', ''],
        bounds.top,
        bounds.bottom,
        bounds.left,
        function(props) {
    ...
    horizontal: function horizontal(bounds) {
      return (0, _styledComponents.css)(
        ['left:', 'px;right:', 'px;top:50%;transform:translate(0,-50%);', ''],
        bounds.left,
        bounds.right,
        function(props) {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['left:', 'px;top:50%;transform:translate(0,-50%);', ''],
        bounds.left,
        function(props) {
  ...
  right: {
    vertical: function vertical(bounds) {
      return (0, _styledComponents.css)(
        ['top:', 'px;bottom:', 'px;right:', 'px;transform:translateX(0);', ''],
        bounds.top,
        bounds.bottom,
        bounds.right,
        function(props) {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['right:', 'px;top:50%;transform:translate(0,-50%);', ''],
        bounds.right,
        function(props) {
  ...
  start: {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['inset-inline-start:', 'px;top:50%;transform:translate(0,-50%);', ''],
        bounds.start,
        function(props) {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['inset-inline-end:', 'px;top:50%;transform:translate(0,-50%);', ''],
        bounds.end,
        function(props) {
  ...
  'top-right': {
    ...
    horizontal: function horizontal(bounds) {
      return (0, _styledComponents.css)(
        ['left:', 'px;right:', 'px;top:0;transform:translateX(0);', ';'],
        bounds.left,
        bounds.right,
        function(props) {
          return getAnimationStyle(props, 'top', 'true');
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['top:', 'px;right:', 'px;transform:translateY(0);', ';'],
        bounds.top,
        bounds.right,
        function(props) {
          return getAnimationStyle(props, 'top', 'true');
  ...
  'top-left': {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['top:', 'px;left:', 'px;transform:translateY(0);', ''],
        bounds.top,
        bounds.left,
        function(props) {
          return getAnimationStyle(props, 'top', 'true');
  ...
  'bottom-right': {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['bottom:', 'px;right:', 'px;transform:translateY(0);', ''],
        bounds.bottom,
        bounds.right,
        function(props) {
          return getAnimationStyle(props, 'bottom', 'true');
  ...
  'bottom-left': {
    ...
    false: function _false(bounds) {
      return (0, _styledComponents.css)(
        ['bottom:', 'px;left:', 'px;transform:translateY(0);', ''],
        bounds.bottom,
        bounds.left,
        function(props) {
          return getAnimationStyle(props, 'bottom', 'true');
...
var roundStyle = function roundStyle(data, theme, position, margin) {
  ...
  if (
    ...
    if (position === 'bottom') {
      ...
      styles.push(
        (0, _styledComponents.css)(['border-radius:0 ', ' 0 0;'], round),
      );
...
var desktopContainerStyle = (0, _styledComponents.css)(
  ...
  function(props) {
    return (
      'calc(100% - ' +
      getBounds(bounds, props.margin, props.theme, 'top') +
      'px - ' +
      getBounds(bounds, props.margin, props.theme, 'bottom') +
      'px)'
    );
  },
  function(props) {
    return (
      'calc(100% - ' +
      getBounds(bounds, props.margin, props.theme, 'left') +
      'px - ' +
      getBounds(bounds, props.margin, props.theme, 'right') +
      'px)'
    );
  },
  function(props) {
    return props.plain || (props.full && props.margin === 'none')
      ? 'border-radius: 0;'
      : roundStyle(
...
var responsiveContainerStyle = function responsiveContainerStyle(props) {
  return (0, _styledComponents.css)(
    [
      'position:relative;max-height:none;max-width:none;border-radius:0;top:0;bottom:0;left:0;right:0;transform:none;animation:none;height:',
      ';width:',
      ';',
    ],
    !props.layerTarget ? '100vh' : '100%',
    !props.layerTarget ? '100vw' : '100%',
  );
};

var elevationStyle = (0, _styledComponents.css)(['box-shadow:', ';'], function(
  props,
) {
  return props.theme.global.elevation[props.theme.dark ? 'dark' : 'light'][
...
var StyledContainer = _styledComponents['default'].div.withConfig({
  ...
  [
    ...
    ';',
    ' outline:none;pointer-events:all;z-index:',
    ';',
    ' ',
    ' ',
    ';',
  ...
  function(props) {
    if (props.responsive && props.theme.layer.responsiveBreakpoint) {
      ...
      if (breakpoint) {
        return (0, _utils.breakpointStyle)(
          breakpoint,
