...
var SelectTextInput = (0, _styledComponents['default'])(
...
var StyledSelectDropButton = (0, _styledComponents['default'])(
...
var Select = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var valuedValue = (0, _react.useMemo)(
    function() {
      if (Array.isArray(value))
        return value.map(function(v) {
          return valueKey && valueKey.reduce
            ? v
            : (0, _utils2.applyKey)(v, valueKey);
        });
      return valueKey && valueKey.reduce
        ? value
        : (0, _utils2.applyKey)(value, valueKey);
    },
    [value, valueKey],
  ); // search input value
  ...
  var optionIndexesInValue = (0, _react.useMemo)(
    function() {
      var result = [];
  ...
  var onRequestOpen = (0, _react.useCallback)(
    function() {
      if (open) return;
      setOpen(true);
      if (onOpen) onOpen();
  ...
  var onRequestClose = (0, _react.useCallback)(
    function() {
      setOpen(false);
      if (onClose) onClose();
    },
  ...
  var onSelectChange = (0, _react.useCallback)(
  ...
  var selectValue = (0, _react.useMemo)(
    function() {
  ...
  var inputValue = (0, _react.useMemo)(
    function() {
      if (!selectValue) {
        if (optionIndexesInValue.length === 0) return '';
        if (optionIndexesInValue.length === 1)
          return (0, _utils2.applyKey)(
  ...
  var iconColor = (0, _utils.normalizeColor)(
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      StyledSelectDropButton,
      {
        ...
        onClick: onClick,
        dropContent: /*#__PURE__*/ _react['default'].createElement(
          _SelectContainer.SelectContainer,
          {
            clear: clear,
            disabled: disabled,
      ...
      /*#__PURE__*/ _react['default'].createElement(
              ...
              _extends(
                {
                  a11yTitle:
                    ...
                    '' +
                      a11yTitle +
                      (value && typeof value === 'string' ? ', ' + value : ''), // When Select is disabled, we want to show a default cursor
        ...
        SelectIcon &&
          /*#__PURE__*/ _react['default'].createElement(
            ...
            /*#__PURE__*/ (0, _react.isValidElement)(SelectIcon)
              ? SelectIcon
              : /*#__PURE__*/ _react['default'].createElement(SelectIcon, {
                  color: iconColor,
                  size: size,
                }),
          ),
