...
var doc = function doc(Select) {
  var DocumentedSelect = (0, _reactDesc.describe)(Select)
    .availableAt((0, _mixins.getAvailableAtBadge)('Select', 'Input'))
  ...
  DocumentedSelect.propTypes = _extends({}, _propTypes.genericProps, {
    children: _reactDesc.PropTypes.func.description(
    ...
    clear: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.shape({
        position: _reactDesc.PropTypes.oneOf(['top', 'bottom'])
          .description(
      ...
      .defaultValue(false),
    closeOnChange: _reactDesc.PropTypes.bool
      .description('Wether to close the drop when a selection is made.')
      .defaultValue(true),
    defaultValue: _reactDesc.PropTypes.oneOfType([
    ...
    disabled: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.arrayOf(
        _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.number,
      ...
      .defaultValue(false),
    disabledKey: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.string,
    ...
    dropHeight: _reactDesc.PropTypes.oneOfType([
    ...
    dropTarget: _reactDesc.PropTypes.object.description(
    ...
    focusIndicator: _reactDesc.PropTypes.bool.description(
      "Whether when 'plain' it should receive a focus outline.",
    ),
    icon: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.func,
    ...
    labelKey: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.string,
      _reactDesc.PropTypes.func,
    ]).description(
    ...
    multiple: _reactDesc.PropTypes.bool.description(
    ...
    name: _reactDesc.PropTypes.string.description(
    ...
    onClose: _reactDesc.PropTypes.func.description(
      'Function that will be called when the Select drop closes.',
    ),
    onOpen: _reactDesc.PropTypes.func.description(
    ...
    options: _reactDesc.PropTypes.arrayOf(
      _reactDesc.PropTypes.oneOfType([
        _reactDesc.PropTypes.string,
        _reactDesc.PropTypes.number,
        _reactDesc.PropTypes.bool,
        _reactDesc.PropTypes.element,
        _reactDesc.PropTypes.object,
      ]),
    ).description(
    ...
    open: _reactDesc.PropTypes.bool.description(
    ...
    plain: _reactDesc.PropTypes.bool.description(
      'Whether this is a plain Select input with no border or padding.',
    ),
    replace: _reactDesc.PropTypes.bool
      .description(
        'Whether to replace previously rendered items with a generic spacing\n      element when they have scrolled out of view. This is more performant but\n      means that in-page searching will not find elements that have been\n      replaced.',
      )
      .defaultValue(true),
    searchPlaceholder: _reactDesc.PropTypes.string.description(
      'Placeholder text to use in the search box when the search input is \n      empty.',
    ),
    selected: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.number,
      _reactDesc.PropTypes.arrayOf(_reactDesc.PropTypes.number),
    ]).description(
    ...
    value: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.string,
      _reactDesc.PropTypes.element, // deprecated, use valueLabel
      _reactDesc.PropTypes.object,
      _reactDesc.PropTypes.number,
      _reactDesc.PropTypes.arrayOf(
        _reactDesc.PropTypes.oneOfType([
    ...
    emptySearchMessage: _reactDesc.PropTypes.string
      .description(
