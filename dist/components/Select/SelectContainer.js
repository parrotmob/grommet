...
var ClearButton = function ClearButton(_ref) {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      _Box.Box,
      _extends({}, theme.select.clear.container, {
        align: align,
      }),
      /*#__PURE__*/ _react['default'].createElement(
        _Text.Text,
...
var SelectContainer = /*#__PURE__*/ (0, _react.forwardRef)(function(
  _ref2,
  ref,
) {
  var clear = _ref2.clear,
    ...
    emptySearchMessage =
      _ref2$emptySearchMess === void 0
        ? 'No matches found'
        : _ref2$emptySearchMess,
    id = _ref2.id,
  ...
  var theme =
    ...
    _defaultProps.defaultProps.theme;
  ...
  var optionLabel = (0, _react.useCallback)(
    function(index) {
      return (0, _utils2.applyKey)(options[index], labelKey);
    },
    [labelKey, options],
  );
  var optionValue = (0, _react.useCallback)(
    function(index) {
      return (0, _utils2.applyKey)(options[index], valueKey);
    },
    [options, valueKey],
  );
  var isDisabled = (0, _react.useCallback)(
    function(index) {
  ...
  var isSelected = (0, _react.useCallback)(
    function(index) {
      var result;
  ...
  var selectOption = (0, _react.useCallback)(
    function(index) {
        ...
        if (onChange) {
          ...
          if (multiple) {
            ...
            nextValue = nextOptionIndexesInValue.map(function(i) {
              return valueKey && valueKey.reduce
                ? (0, _utils2.applyKey)(allOptions[i], valueKey)
                : allOptions[i];
            });
            ...
            nextValue =
              valueKey && valueKey.reduce
                ? (0, _utils2.applyKey)(options[index], valueKey)
                : options[index];
            nextSelected = index;
          }
  ...
  var onNextOption = (0, _react.useCallback)(
    function(event) {
  ...
  var onPreviousOption = (0, _react.useCallback)(
    function(event) {
      event.preventDefault();
      var nextActiveIndex = activeIndex - 1;
  ...
  var onKeyDownOption = (0, _react.useCallback)(
    function(event) {
      if (!onSearch) {
        event.preventDefault();
  ...
  var onActiveOption = (0, _react.useCallback)(
    function(index) {
      return function() {
  ...
  var onSelectOption = (0, _react.useCallback)(
    function(event) {
  ...
  var selectOptionsStyle = theme.select.options
    ? _extends({}, theme.select.options.box, theme.select.options.container)
    : {};
  return /*#__PURE__*/ _react['default'].createElement(
    _Keyboard.Keyboard,
    {
    ...
    /*#__PURE__*/ _react['default'].createElement(
      ...
      clear &&
        ...
        value &&
        /*#__PURE__*/ _react['default'].createElement(ClearButton, {
          clear: clear,
          name: name,
          onClear: onClear,
          theme: theme,
          ...
          ? /*#__PURE__*/ _react['default'].createElement(
              ...
              function(option, index, optionRef) {
                ...
                if (children)
                  ...
                  child = /*#__PURE__*/ _react['default'].createElement(
                    OptionBox,
                    _extends({}, selectOptionsStyle, {
                      selected: optionSelected,
                    }),
                    /*#__PURE__*/ _react['default'].createElement(
                      _Text.Text,
                ...
                return /*#__PURE__*/ _react['default'].createElement(
                  SelectOption, // eslint-disable-next-line react/no-array-index-key
                  {
                    key: index,
                    ref: optionRef,
                    tabIndex: '-1',
