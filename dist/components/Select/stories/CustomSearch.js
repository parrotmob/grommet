    ...
    /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ _react['default'].createElement(
        _grommet.Select,
        {
          ...
          searching: searching,
          multiple: true,
          value: selectedContentPartners.length
          ...
          onChange: function onChange(_ref3) {
            ...
            var seasonIndex = newSelectedPartners
              .map(function(_ref4) {
                var name = _ref4.name;
                return name;
              })
            ...
            var sortedContentPartners = []
              .concat(allContentPartners)
              .sort(sortContentPartners(selectedPartnerNames));
