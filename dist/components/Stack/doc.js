...
var doc = function doc(Stack) {
  var DocumentedStack = (0, _reactDesc.describe)(Stack)
    .availableAt((0, _mixins.getAvailableAtBadge)('Stack', 'Layout'))
    .description(
  ...
  DocumentedStack.propTypes = _extends({}, _propTypes.genericProps, {
