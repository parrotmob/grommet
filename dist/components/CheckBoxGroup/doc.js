...
var doc = function doc(CheckBoxGroup) {
  var DocumentedCheckBoxGroup = (0, _reactDesc.describe)(CheckBoxGroup)
    .availableAt((0, _utils.getAvailableAtBadge)('CheckBoxGroup', 'Input'))
  ...
  DocumentedCheckBoxGroup.propTypes = {
    value: _reactDesc.PropTypes.arrayOf(
    ...
    labelKey: _reactDesc.PropTypes.string.description(
    ...
    valueKey: _reactDesc.PropTypes.string.description(
