...
var StyledDataTable = (0, _styledComponents['default'])(
  _Table.Table,
).withConfig({
  ...
  [
    'position:relative;border-spacing:0;border-collapse:separate;height:auto;',
    ' ',
    ' ',
    ';',
  ],
...
var StyledDataTableRow = (0, _styledComponents['default'])(
  _TableRow.TableRow,
).withConfig({
