...
var separateThemeProps = function separateThemeProps(theme) {
  var _theme$dataTable$head = theme.dataTable.header,
    ...
    rest = _objectWithoutPropertiesLoose(_theme$dataTable$head, [
      'background',
      'border',
      'color',
      'font',
...
var buttonStyle = function buttonStyle(_ref) {
  ...
  if (layoutProps.hover) {
    ...
    if (partStyles.length > 0)
      styles.push((0, _styledComponents.css)(['&:hover{', '}'], partStyles));
  }
  ...
  if (iconProps.color) {
    styles.push(
      (0, _styledComponents.css)(
        ['svg{stroke:', ';fill:', ';}'],
        (0, _colors.normalizeColor)(iconProps.color, theme),
        (0, _colors.normalizeColor)(iconProps.color, theme),
      ),
    );
  }
...
var StyledHeaderCellButton = (0, _styledComponents['default'])(
  _Button.Button,
).withConfig({
    ...
    /*#__PURE__*/ _react['default'].createElement(
                ...
                // if none are selected, select all data
                  ...
                  onSelect(
                    data.map(function(datum) {
                      return (0,
                      _buildState.datumValue)(datum, primaryProperty);
                    }),
                  );
              },
            }),
      ...
      columns.map(function(_ref3) {
        ...
        var unitsContent = units
          ? /*#__PURE__*/ _react['default'].createElement(
              _Text.Text,
              _extends({}, textProps, theme.dataTable.header.units),
              units,
            )
          : undefined;
        ...
        if (search || onResize) {
          var resizer = onResize
            ? /*#__PURE__*/ _react['default'].createElement(_Resizer.Resizer, {
                property: property,
                onResize: onResize,
              })
            : null;
        ...
        return /*#__PURE__*/ _react['default'].createElement(
          _StyledDataTable.StyledDataTableCell,
          {
            key: property,
            align: align,
            context: 'header',
