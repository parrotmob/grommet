...
var doc = function doc(SkipLinks) {
  var DocumentedSkipLinks = (0, _reactDesc.describe)(SkipLinks)
    .availableAt((0, _mixins.getAvailableAtBadge)('SkipLinks', 'Utilities'))
  ...
  DocumentedSkipLinks.propTypes = {
    children: _reactDesc.PropTypes.node.description('Array of SkipLink')
      .isRequired,
