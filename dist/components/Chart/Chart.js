...
var Chart = /*#__PURE__*/ _react['default'].forwardRef(function(_ref, ref) {
  ...
  var theme =
    ...
    _defaultProps.defaultProps.theme; // normalize variables
  ...
  var bounds = (0, _react.useMemo)(
    function() {
      return (0, _utils2.normalizeBounds)(propsBounds, values);
    },
    [propsBounds, values],
  );
  var strokeWidth = (0, _react.useMemo)(
    function() {
      return (0, _utils.parseMetricToNum)(
        theme.global.edgeSize[thickness] || thickness,
      );
    },
    [theme.global.edgeSize, thickness],
  );
  var inset = (0, _react.useMemo)(
    function() {
      var result = [0, 0, 0, 0];

      if (pad) {
        if (pad.horizontal) {
          var padSize = (0, _utils.parseMetricToNum)(
        ...
        if (pad.vertical) {
          var _padSize = (0, _utils.parseMetricToNum)(
            theme.global.edgeSize[pad.vertical],
          );
        ...
        if (typeof pad === 'string') {
          var _padSize2 = (0, _utils.parseMetricToNum)(
            theme.global.edgeSize[pad],
          );
  ...
  var strokeDasharray = (0, _react.useMemo)(
    function() {
      if (dash) {
  ...
  var needContainerSize = (0, _react.useMemo)(
    function() {
      return (
        propsSize &&
        (propsSize === 'full' ||
  ...
  var size = (0, _react.useMemo)(
    function() {
      var gapWidth = gap
        ? (0, _utils.parseMetricToNum)(theme.global.edgeSize[gap] || gap)
        : strokeWidth; // autoWidth is how wide we'd pefer
      ...
      if (sizeWidth === 'full' || sizeWidth === 'fill') {
        ...
        width = (0, _utils.parseMetricToNum)(
      ...
      if (sizeHeight === 'full' || sizeHeight === 'fill') {
        ...
        height = (0, _utils.parseMetricToNum)(
  ...
  var viewBounds = (0, _react.useMemo)(
    function() {
      return overflow
        ? [0, 0, size[0], size[1]]
        : [
    ...
    return (values || [])
      ...
      .map(function(valueArg, index) {
        var valueColor = valueArg.color,
          ...
          valueRest = _objectWithoutPropertiesLoose(valueArg, [
            'color',
            'label',
            'onHover',
            'opacity',
        ...
        var d =
          'M ' +
          valueToCoordinate(value[0], bottom).join(',') +
        ...
        return /*#__PURE__*/ _react['default'].createElement(
          'g',
          {
            ...
            fill: 'none',
            stroke: valueColor
              ? (0, _utils.normalizeColor)(valueColor, theme)
              : undefined,
          ...
          /*#__PURE__*/ _react['default'].createElement('title', null, label),
    ...
    (values || [])
      ...
      .forEach(function(_ref4) {
        ...
        d +=
          (d ? ' L' : 'M') +
          ' ' +
          valueToCoordinate(value[0], value[1]).join(',');

        if (value[2] !== undefined) {
          d2 +=
            (d2 ? ' L' : 'M') +
            ' ' +
            valueToCoordinate(value[0], value[2]).join(',');
        }
      });
    var hoverProps;
    ...
    (values || [])
      ...
      .forEach(function(_ref6, index) {
        ...
        d +=
          (!index ? 'M' : ' L') +
          ' ' +
          valueToCoordinate(value[0], value[value.length === 2 ? 1 : 2]).join(
            ',',
          );
      });
    (values || [])
      ...
      .forEach(function(_ref8) {
        ...
        d +=
          ' L ' +
          valueToCoordinate(
            value[0], // Math.max() is to account for value[1] being negative
  ...
  if (type !== 'point') {
    ...
    else stroke = (0, _utils.normalizeColor)(colorName, theme);
  } else stroke = 'none';
  ...
  if (type === 'point' || type === 'area') {
    ...
    else fill = (0, _utils.normalizeColor)(colorName, theme);
  } else fill = 'none';

  var drawing = /*#__PURE__*/ _react['default'].createElement(
    'g',
    {
      stroke: stroke,
      strokeWidth:
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    defs.length &&
      /*#__PURE__*/ _react['default'].createElement('defs', null, defs),
