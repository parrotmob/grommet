...
var doc = function doc(Chart) {
  var DocumentedChart = (0, _reactDesc.describe)(Chart)
    .availableAt((0, _mixins.getAvailableAtBadge)('Chart', 'Visualizations'))
  ...
  DocumentedChart.propTypes = _extends({}, _propTypes.genericProps, {
    ...
    bounds: _reactDesc.PropTypes.arrayOf(
    ...
    onHover: _reactDesc.PropTypes.func.description(
    ...
    pattern: _propTypes.patternPropType.description(
      "When using an 'area' type, what pattern to fill the area with.",
    ),
    point: _propTypes.pointPropType.description(
    ...
    type: _reactDesc.PropTypes.oneOf(['bar', 'line', 'area', 'point'])
      ...
      .defaultValue('bar'),
    values: _reactDesc.PropTypes.arrayOf(
      _reactDesc.PropTypes.oneOfType([
        ...
        _reactDesc.PropTypes.shape({
          ...
          value: _reactDesc.PropTypes.oneOfType([
            _reactDesc.PropTypes.number.isRequired,
            _reactDesc.PropTypes.arrayOf(_reactDesc.PropTypes.number)
              .isRequired,
          ]).isRequired,
        }),
...
var docCalcs = function docCalcs(calcs) {
  var DocumentedCalcs = (0, _reactDesc.describe)(calcs)
    .description(
