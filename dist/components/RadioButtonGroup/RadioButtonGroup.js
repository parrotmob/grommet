...
var RadioButtonGroup = /*#__PURE__*/ (0, _react.forwardRef)(function(
  _ref,
  ref,
) {
  ...
  var theme =
    ...
    _defaultProps.defaultProps.theme; // normalize options to always use an object
  ...
  var valueIndex = _react['default'].useMemo(
    function() {
      var result;
    ...
    /*#__PURE__*/ _react['default'].createElement(
      ...
      options.map(function(_ref2, index) {
        var optionDisabled = _ref2.disabled,
          ...
          optionRest = _objectWithoutPropertiesLoose(_ref2, [
            'disabled',
            'id',
            'label',
            'value',
