...
var ContainerBox = (0, _styledComponents['default'])(_Box.Box).withConfig({
  ...
  function(props) {
    return props.dropHeight
      ? (0, _utils.sizeStyle)('max-height', props.dropHeight, props.theme)
      : 'max-height: inherit;';
  },
);
...
var TextInput = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  var a11yTitle = _ref.a11yTitle,
    ...
    suggestionsFooter = _ref.suggestionsFooter,
  ...
  var handleSuggestionSelect = (0, _react.useMemo)(
    function() {
      return onSelect && !onSuggestionSelect ? onSelect : onSuggestionSelect;
    },
    [onSelect, onSuggestionSelect],
  );
  var handleTextSelect = (0, _react.useMemo)(
    function() {
  ...
  var openDrop = (0, _react.useCallback)(
    function() {
      setShowDrop(true);
  ...
  var closeDrop = (0, _react.useCallback)(
    function() {
  ...
  var valueSuggestionIndex = (0, _react.useMemo)(
    function() {
      return suggestions
        ? suggestions
  ...
  var resetSuggestionIndex = (0, _react.useMemo)(
    function() {
      if (
      ...
      var timer = setTimeout(function() {
        ...
        if (showDrop && activeSuggestionIndex !== -1 && list) {
          ...
          if (container.scrollTo) {
            if ((0, _utils.isNodeAfterScroll)(item, container))
              container.scrollTo(
                0,
                item.offsetTop -
            ...
            else if ((0, _utils.isNodeBeforeScroll)(item, container))
  ...
  var setValueFromSuggestion = function setValueFromSuggestion(
    event,
    suggestion,
  ) {
  ...
  var onNextSuggestion = (0, _react.useCallback)(
    function(event) {
      event.preventDefault();
      var nextActiveIndex = Math.min(
  ...
  var onPreviousSuggestion = (0, _react.useCallback)(
    function(event) {
      event.preventDefault();
  ...
  if (showDrop) {
    drop = /*#__PURE__*/ _react['default'].createElement(
      _Drop.Drop,
      _extends(
        {
          ref: dropRef,
              ...
              return /*#__PURE__*/ _react['default'].createElement(
                ...
                /*#__PURE__*/ _react['default'].createElement(
                  _Button.Button,
                  {
                    ...
                    onMouseMove:
                      mouseMovedSinceLastKey && activeSuggestionIndex !== index
                        ? function() {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ _react['default'].createElement(
        _StyledTextInput.StyledTextInput,
        _extends(
          {
