...
var doc = function doc(TextInput) {
  var DocumentedTextInput = (0, _reactDesc.describe)(TextInput)
    .availableAt((0, _mixins.getAvailableAtBadge)('TextInput', 'Input'))
    .description(
  ...
  DocumentedTextInput.propTypes = {
    a11yTitle: _reactDesc.PropTypes.string.description(
      'Custom title to be used by screen readers.',
    ),
    defaultSuggestion: _reactDesc.PropTypes.number.description(
    ...
    icon: _reactDesc.PropTypes.element.description(
    ...
    id: _reactDesc.PropTypes.string.description(
    ...
    onSuggestionSelect: _reactDesc.PropTypes.func.description(
      'Function that will be called when the user selects a suggestion.\n      The suggestion contains the object chosen from the supplied suggestions.',
    ),
    onSuggestionsOpen: _reactDesc.PropTypes.func.description(
      'Function that will be called when the suggestions drop is opened.',
    ),
    onSuggestionsClose: _reactDesc.PropTypes.func.description(
      'Function that will be called when the suggestions drop is closed.',
    ),
    placeholder: _reactDesc.PropTypes.node.description(
      'Placeholder to use when no value is provided.',
    ),
    plain: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf(['full']),
    ]).description(
    ...
    reverse: _reactDesc.PropTypes.bool.description(
    ...
    suggestions: _reactDesc.PropTypes.arrayOf(
    ...
    textAlign: _reactDesc.PropTypes.oneOf(['start', 'center', 'end'])
...
var themeDoc = _extends(
  ...
  _themeDocUtils.themeDocUtils.focusStyle,
  _themeDocUtils.themeDocUtils.placeholderStyle,
  _themeDocUtils.themeDocUtils.disabledStyle,
  _themeDocUtils.themeDocUtils.inputStyle,
);
