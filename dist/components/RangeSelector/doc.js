...
var doc = function doc(RangeSelector) {
  var DocumentedRangeSelector = (0, _reactDesc.describe)(RangeSelector)
    .availableAt((0, _mixins.getAvailableAtBadge)('RangeSelector', 'Input'))
  ...
  DocumentedRangeSelector.propTypes = {
    ...
    direction: _reactDesc.PropTypes.oneOf(['horizontal', 'vertical'])
      .description('')
      .defaultValue('horizontal'),
    invert: _reactDesc.PropTypes.bool.description(
    ...
    min: _reactDesc.PropTypes.number
    ...
    ).description('The current values.').isRequired,
  };
