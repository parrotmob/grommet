...
var RangeSelector = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var valueForMouseCoord = (0, _react.useCallback)(
    function(event) {
  ...
  var thickness =
    size === 'full'
      ? undefined
      : (0, _utils.parseMetricToNum)(theme.global.edgeSize[size] || size) +
        'px';
  var layoutProps = {
    fill: direction,
    round: round,
      ...
      _extends(
        {
          ...
          background: invert
            ? undefined // preserve existing dark, instead of using darknes of
            : // this color
              {
                color: color || 'control',
                opacity: opacity,
