...
var doc = function doc(Accordion) {
  var DocumentedAccordion = (0, _reactDesc.describe)(Accordion)
    .availableAt((0, _mixins.getAvailableAtBadge)('Accordion', 'Controls'))
  ...
  DocumentedAccordion.propTypes = _extends({}, _propTypes.genericProps, {
    activeIndex: _reactDesc.PropTypes.oneOfType([
    ...
    animate: _reactDesc.PropTypes.bool
      ...
      .defaultValue(true),
    children: _reactDesc.PropTypes.node.description(
      'Array of AccordionPanels.',
    ),
    onActive: _reactDesc.PropTypes.func.description(
    ...
    multiple: _reactDesc.PropTypes.bool
