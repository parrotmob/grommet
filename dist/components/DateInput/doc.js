...
var doc = function doc(DateInput) {
  var DocumentedDateInput = (0, _reactDesc.describe)(DateInput)
    .availableAt((0, _utils.getAvailableAtBadge)('DateInput', 'Input'))
  ...
  DocumentedDateInput.propTypes = {
    buttonProps: _reactDesc.PropTypes.shape({}).description(
      'Any properties to pass on to the underlying DropButton\n      when not inline and no format.',
    ),
    calendarProps: _reactDesc.PropTypes.shape({}).description(
    ...
    format: _reactDesc.PropTypes.string.description(
