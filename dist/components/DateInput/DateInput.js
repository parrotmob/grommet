...
var DateInput = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, refArg) {
  ...
  var _useState = (0, _react.useState)(
      schema ? (0, _utils2.valueToText)(value, schema) : undefined,
    ),
    ...
    _extends(
      {
        ...
        onSelect: disabled
          ...
          : function(nextValue) {
              ...
              if (schema)
                setTextValue((0, _utils2.valueToText)(normalizedValue, schema));
  ...
  var input = /*#__PURE__*/ _react['default'].createElement(
    _Form.FormContext.Provider,
    {
