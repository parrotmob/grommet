...
var doc = function doc(Menu) {
  var DocumentedMenu = (0, _reactDesc.describe)(Menu)
    .availableAt((0, _mixins.getAvailableAtBadge)('Menu', 'Controls'))
  ...
  DocumentedMenu.propTypes = _extends({}, _propTypes.genericProps, {
    ...
    dropBackground: _reactDesc.PropTypes.oneOfType([
    ...
    items: _reactDesc.PropTypes.arrayOf(
    ...
    open: _reactDesc.PropTypes.bool
