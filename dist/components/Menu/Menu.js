...
var Menu = /*#__PURE__*/ (0, _react.forwardRef)(function(props, ref) {
  ...
  var iconColor = (0, _utils.normalizeColor)(
    theme.menu.icons.color || 'control',
    theme,
  );
  var align = dropProps.align || dropAlign;
  var controlButtonIndex = (0, _react.useMemo)(
    function() {
  ...
  var buttonRefs = {};
  var constants = (0, _react.useMemo)(
    function() {
      return {
        none: 'none',
        tab: 9,
  ...
  var onDropClose = (0, _react.useCallback)(
    function() {
  ...
  var controlMirror = /*#__PURE__*/ _react['default'].createElement(
    _Box.Box,
    {
      flex: false,
    },
