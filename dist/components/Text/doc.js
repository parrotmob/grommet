...
var doc = function doc(Text) {
  var DocumentedText = (0, _reactDesc.describe)(Text)
    .availableAt((0, _mixins.getAvailableAtBadge)('Text', 'Type'))
  ...
  DocumentedText.propTypes = _extends({}, _propTypes.genericProps, {
    ...
    margin: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['none'].concat(_propTypes.MARGIN_SIZES)),
      _reactDesc.PropTypes.shape({
        bottom: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf(_propTypes.MARGIN_SIZES),
    ...
    textAlign: _reactDesc.PropTypes.oneOf(['start', 'center', 'end'])
      ...
      .defaultValue('start'),
    truncate: _reactDesc.PropTypes.bool
      .description(
      ...
      .defaultValue(false),
    weight: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['normal', 'bold']),
      _reactDesc.PropTypes.number,
    ]).description('Font weight'),
    wordBreak: _reactDesc.PropTypes.oneOf([
      'normal',
      'break-all',
      'keep-all',
      'break-word',
