...
var weightStyle = (0, _styledComponents.css)(['font-weight:', ';'], function(
  props,
) {
  return props.weight;
});
var wordBreakStyle = (0, _styledComponents.css)(['word-break:', ';'], function(
  props,
) {
  return props.wordBreak;
});
var fontFamily = (0, _styledComponents.css)(['font-family:', ';'], function(
  props,
) {
