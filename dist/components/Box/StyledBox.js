...
var alignStyle = (0, _styledComponents.css)(['align-items:', ';'], function(
  props,
) {
...
var basisStyle = (0, _styledComponents.css)(['flex-basis:', ';'], function(
  props,
) {
  return (
...
var directionStyle = function directionStyle(direction, theme) {
  ...
  if (direction === 'row-responsive' && theme.box.responsiveBreakpoint) {
    var breakpoint = (0, _utils.getBreakpointStyle)(
      theme,
...
var justifyStyle = (0, _styledComponents.css)(
  ['justify-content:', ';'],
  function(props) {
...
var wrapStyle = (0, _styledComponents.css)(['flex-wrap:', ';'], function(
  props,
) {
...
var roundStyle = function roundStyle(data, responsive, theme) {
  ...
  if (typeof data === 'object') {
    ...
    styles.push(
      (0, _styledComponents.css)(
        ['border-radius:', ';'],
        ROUND_MAP[_size] || theme.global.edgeSize[_size] || _size,
      ),
    );
...
var animationObjectStyle = function animationObjectStyle(animation, theme) {
  ...
  if (bounds) {
    ...
    return (0, _styledComponents.css)(
      ['', ' ', ' ', ' ', ''],
      (0, _styledComponents.keyframes)(['', ''], animationTransition),
      normalizeTiming(
        animation.duration,
...
var animationItemStyle = function animationItemStyle(item, theme) {
  ...
  if (Array.isArray(item)) {
    return item.reduce(function(style, a, index) {
      return (0,
      _styledComponents.css)(['', '', ' ', ''], style, index > 0 ? ',' : '', animationItemStyle(a, theme));
    }, '');
  }
...
var animationObjectInitialStyle = function animationObjectInitialStyle(
  animation,
) {
  var bounds = animationBounds(animation.type, animation.size);
...
var animationStyle = (0, _styledComponents.css)(['', ';'], function(props) {
  return (0,
  _styledComponents.css)(['', ' animation:', ';'], animationInitialStyle(props.animation), animationItemStyle(props.animation, props.theme));
});
var interactiveStyle = (0, _styledComponents.css)(
  ['cursor:pointer;&:hover{', '}'],
  function(props) {
    return (
      props.hoverIndicator &&
      (0, _utils.getHoverIndicatorStyle)(props.hoverIndicator, props.theme)
    );
  },
);
...
var heightObjectStyle = (0, _styledComponents.css)(
  ['', ';', ';'],
  function(props) {
    return (
      ...
      (0, _styledComponents.css)(
        ['max-height:', ';'],
        getSize(props, props.heightProp.max),
      )
    );
  },
  function(props) {
    return (
      ...
      (0, _styledComponents.css)(
        ['min-height:', ';'],
        getSize(props, props.heightProp.min),
      )
    );
  },
);
...
var widthObjectStyle = (0, _styledComponents.css)(
  ['', ';', ';', ';'],
  function(props) {
    return (
      props.widthProp.max &&
      (0, _styledComponents.css)(
        ['max-width:', ';'],
        getSize(props, props.widthProp.max),
      )
    );
  },
  function(props) {
    return (
      ...
      (0, _styledComponents.css)(
        ['min-width:', ';'],
        getSize(props, props.widthProp.min),
      )
    );
  },
  function(props) {
    return (
      ...
      (0, _styledComponents.css)(
        ['width:', ';'],
        getSize(props, props.widthProp.width),
      )
    );
  },
);
...
var StyledBox = _styledComponents['default'].div.withConfig({
  ...
  function(props) {
    return (
      props.background &&
      (0, _utils.backgroundStyle)(props.background, props.theme)
    );
  },
  function(props) {
    return (
      ...
      (Array.isArray(props.border)
        ? props.border.map(function(border) {
            return (0,
            _utils.borderStyle)(border, props.responsive, props.theme);
          })
...
var gapStyle = function gapStyle(
  ...
  if (border === 'between' || (border && border.side === 'between')) {
    ...
    var borderOffset =
      (0, _utils.parseMetricToNum)(metric) / 2 -
      (0, _utils.parseMetricToNum)(borderMetric) / 2 +
      'px';
    var responsiveBorderMetric =
      responsive &&
      breakpoint &&
      (breakpoint.borderSize[borderSize] || borderSize);
    var responsiveBorderOffset =
      responsiveBorderMetric &&
      (0, _utils.parseMetricToNum)(responsiveMetric) / 2 -
        (0, _utils.parseMetricToNum)(responsiveBorderMetric) / 2 +
        'px';
    ...
    if (directionProp === 'column' || directionProp === 'column-reverse') {
      ...
      styles.push(
        (0, _styledComponents.css)(
          ...
          borderOffset,
          (0, _utils.borderStyle)(adjustedBorder, responsive, theme),
        ),
      );
