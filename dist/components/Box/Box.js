...
var Box = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var focusable = (0, _react.useMemo)(
    function() {
  ...
  var clickProps = (0, _react.useMemo)(
    function() {
      if (focusable) {
        return {
          onClick: onClick,
  ...
  var adjustedTabIndex = (0, _react.useMemo)(
    function() {
        ...
        if (firstIndex === undefined) {
          ...
          contents.push(
            /*#__PURE__*/ _react['default'].createElement(
              _StyledBox.StyledBoxGap, // eslint-disable-next-line react/no-array-index-key
              {
                key: 'gap-' + index,
