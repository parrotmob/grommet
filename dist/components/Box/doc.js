...
var ANIMATION_TYPE = _reactDesc.PropTypes.oneOf([
  'fadeIn',
  'fadeOut',
  'jiggle',
  'pulse',
...
var ANIMATION_SHAPE = _reactDesc.PropTypes.shape({
  ...
  size: _reactDesc.PropTypes.oneOf([
    'xsmall',
    'small',
    'medium',
    'large',
...
var overflowPropType = _reactDesc.PropTypes.oneOfType([
  _reactDesc.PropTypes.oneOf(OVERFLOW_VALUES),
...
var doc = function doc(Box) {
  var DocumentedBox = (0, _reactDesc.describe)(Box)
    .availableAt((0, _mixins.getAvailableAtBadge)('Box', 'Layout'))
    .description(
  ...
  DocumentedBox.propTypes = _extends({}, _propTypes.genericProps, {
    align: _reactDesc.PropTypes.oneOf([
      'start',
      'center',
      'end',
      'baseline',
    ...
    alignContent: _reactDesc.PropTypes.oneOf([
      'start',
      'center',
      'end',
      'between',
    ...
    animation: _reactDesc.PropTypes.oneOfType([
      ANIMATION_TYPE,
      ANIMATION_SHAPE,
      _reactDesc.PropTypes.arrayOf(
        _reactDesc.PropTypes.oneOfType([ANIMATION_TYPE, ANIMATION_SHAPE]),
      ),
    ]).description(
      "Animation effect(s) to use. 'duration' and 'delay' should\n        be in milliseconds. 'jiggle' and 'pulse' types are intended for\n        small elements, like icons.",
    ),
    background: _propTypes.backgroundDoc,
    basis: _reactDesc.PropTypes.oneOfType([
    ...
    direction: _reactDesc.PropTypes.oneOf([
      ...
      .defaultValue('column'),
    elevation: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf([
        'none',
        'xsmall',
        'small',
      ...
      .defaultValue('none'),
    flex: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['grow', 'shrink']),
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.shape({
    ...
    focusIndicator: _reactDesc.PropTypes.bool
      .description(
        "When interactive via 'onClick', whether it should receive a focus\n        outline.",
      )
      .defaultValue(true),
    gap: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf([
        'none',
        'xxsmall',
        'xsmall',
    ...
    height: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf([
        'xxsmall',
        'xsmall',
        'small',
      ...
      _reactDesc.PropTypes.string,
      _reactDesc.PropTypes.shape({
        min: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf([
            'xxsmall',
            'xsmall',
            'small',
        ...
        max: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.oneOf([
            'xxsmall',
            'xsmall',
            'small',
    ...
    justify: _reactDesc.PropTypes.oneOf([
      ...
      .defaultValue('stretch'),
    onClick: _reactDesc.PropTypes.func.description(
    ...
    pad: _propTypes.padPropType,
    responsive: _reactDesc.PropTypes.bool
      .description(
        'Whether margin, pad, and border\n      sizes should be scaled for mobile environments.',
      )
      .defaultValue(true),
    round: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf([
        'xsmall',
        'small',
      ...
      _reactDesc.PropTypes.string,
      _reactDesc.PropTypes.shape({
        corner: _reactDesc.PropTypes.oneOf([
          'top',
          'left',
          'bottom',
          'right',
    ...
    wrap: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.oneOf(['reverse']),
    ])
...
var themeDoc = _extends(
  ...
  _themeDocUtils.themeDocUtils.edgeStyle(
    'The possible sizes for any of gap, margin, and pad.',
  ),
  _themeDocUtils.themeDocUtils.breakpointStyle(
