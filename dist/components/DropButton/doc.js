...
var doc = function doc(DropButton) {
  var DocumentedDropButton = (0, _reactDesc.describe)(DropButton)
    .availableAt((0, _mixins.getAvailableAtBadge)('DropButton', 'Controls'))
    .description(
  ...
  DocumentedDropButton.propTypes = _extends({}, _propTypes.genericProps, {
    ...
    dropContent: _reactDesc.PropTypes.element.description(
