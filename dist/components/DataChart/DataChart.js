...
var DataChart = /*#__PURE__*/ (0, _react.forwardRef)(function(_ref, ref) {
  ...
  var seriesValues = (0, _react.useMemo)(
    function() {
      var result = {};
  ...
  var chartValues = (0, _react.useMemo)(
    function() {
  ...
  var granularities = (0, _react.useMemo)(
    function() {
      ...
      return {
        ...
        y: _extends(
          {},
          _utils.heightYGranularity[(size && size.height) || 'small'] || {
            fine: 5,
            medium: 3,
          },
          {
    ...
    function() {
      ...
      if (result.x) {
        var _result$x$granularity = result.x.granularity,
          granularity =
            _result$x$granularity === void 0 ? 'coarse' : _result$x$granularity;
      ...
      if (result.y) {
        var _result$y$granularity = result.y.granularity,
          _granularity =
            _result$y$granularity === void 0 ? 'coarse' : _result$y$granularity;
  ...
  var chartProps = (0, _react.useMemo)(
    function() {
      var steps = [];
      ...
      if (axis && axis.x) {
        var _axis$x$granularity = axis.x.granularity,
          granularity =
            _axis$x$granularity === void 0 ? 'coarse' : _axis$x$granularity;
      ...
      if (axis && axis.y) {
        var _axis$y$granularity = axis.y.granularity,
          _granularity2 =
            _axis$y$granularity === void 0 ? 'coarse' : _axis$y$granularity;
  ...
  var seriesStyles = (0, _react.useMemo)(
    function() {
  ...
  var dateFormats = (0, _react.useMemo)(
    function() {
      var result = {};
      ...
      series.forEach(function(_ref8) {
        ...
        if (
          ...
          result[property] = (0, _utils.createDateFormat)(
            data[0][property],
  ...
  var xAxisElement =
    axis && axis.x && chartProps.length
      ? /*#__PURE__*/ _react['default'].createElement(_XAxis.XAxis, {
          ref: xRef,
          axis: axis,
  ...
  var yAxisElement =
    axis && axis.y && chartProps.length
      ? /*#__PURE__*/ _react['default'].createElement(_YAxis.YAxis, {
          axis: axis,
          chartProps: chartProps,
          pad: pad,
          renderValue: renderValue,
      ...
      : null;
  var stackFill = (0, _react.useMemo)(
    function() {
      if (
        size === 'fill' ||
  ...
  var guidingChild = (0, _react.useMemo)(
    function() {
      var result = 0;
  ...
  var stackElement = /*#__PURE__*/ _react['default'].createElement(
    _Stack.Stack,
    {
      gridArea: 'charts',
    ...
    guide &&
      guide.x &&
      /*#__PURE__*/ _react['default'].createElement(_XGuide.XGuide, {
        guide: guide,
        pad: pad,
      }),
    guide &&
      guide.y &&
      /*#__PURE__*/ _react['default'].createElement(_YGuide.YGuide, {
        guide: guide,
        pad: pad,
      }),
    charts.map(function(_ref9, i) {
      var prop = _ref9.property,
        ...
        x = _ref9.x,
        y = _ref9.y,
        chartRest = _objectWithoutPropertiesLoose(_ref9, [
          'property',
          'type',
          'x',
          'y',
      ...
      if (type === 'bars') {
        ...
        return prop
          .map(function(cProp, j) {
            var pProp = cProp.property || cProp;
            return /*#__PURE__*/ _react['default'].createElement(
              _Chart.Chart, // eslint-disable-next-line react/no-array-index-key
              _extends(
                {
    ...
    detail &&
      /*#__PURE__*/ _react['default'].createElement(_Detail.Detail, {
  ...
  if (!_Grid.Grid.available) {
    ...
    if (xAxisElement) {
      _content = /*#__PURE__*/ _react['default'].createElement(
        _Box.Box,
        null,
        _content,
        xAxisElement,
