...
var colorType = _reactDesc.PropTypes.oneOfType([
...
var thicknessType = _reactDesc.PropTypes.oneOfType([
...
var chartType = _reactDesc.PropTypes.oneOfType([
  _reactDesc.PropTypes.string,
  _reactDesc.PropTypes.shape({
    property: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.string,
      _reactDesc.PropTypes.arrayOf(
      ...
      _reactDesc.PropTypes.shape({
        ...
        thickness: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.string,
          _reactDesc.PropTypes.shape({
            property: _reactDesc.PropTypes.string,
            transform: _reactDesc.PropTypes.func,
    ...
    opacity: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['weak', 'medium', 'strong']),
...
var seriesType = _reactDesc.PropTypes.oneOfType([
  _reactDesc.PropTypes.string, // property
  _reactDesc.PropTypes.shape({
...
var doc = function doc(DataChart) {
  var DocumentedDataChart = (0, _reactDesc.describe)(DataChart)
    .availableAt(
      (0, _mixins.getAvailableAtBadge)('DataChart', 'Visualizations'),
    )
    .description(
  ...
  DocumentedDataChart.propTypes = _extends({}, _propTypes.genericProps, {
    axis: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.shape({
        x: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.bool,
          _reactDesc.PropTypes.string,
          _reactDesc.PropTypes.shape({
            property: _reactDesc.PropTypes.string,
        ...
        y: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.bool,
          _reactDesc.PropTypes.string,
          _reactDesc.PropTypes.shape({
            property: _reactDesc.PropTypes.string,
      ...
      .defaultValue(true),
    bounds: _reactDesc.PropTypes.oneOf(['align'])
      .description(
      ...
      .defaultValue('align'),
    chart: _reactDesc.PropTypes.oneOfType([
      chartType,
      _reactDesc.PropTypes.arrayOf(chartType),
    ]).description(
    ...
    detail: _reactDesc.PropTypes.bool.description(
    ...
    guide: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.bool,
      _reactDesc.PropTypes.shape({
        x: _reactDesc.PropTypes.oneOfType([
          _reactDesc.PropTypes.bool,
    ...
    legend: _reactDesc.PropTypes.bool.description(
      'Whether to include a legend',
    ),
    pad: _propTypes.padPropType.description(
      'Spacing around the outer edge of\n    the drawing coordinate area for the graphic elements to overflow into.',
    ),
    series: _reactDesc.PropTypes.oneOfType([
      seriesType,
      _reactDesc.PropTypes.arrayOf(seriesType),
    ]).description(
    ...
    size: _reactDesc.PropTypes.oneOfType([
      _reactDesc.PropTypes.oneOf(['fill']),
      _reactDesc.PropTypes.shape({
